...
public class TableToXls {
	...
	// static init
	static {
		STYLE_APPLIERS.add((CssApplier) new AlignApplier());
		STYLE_APPLIERS.add((CssApplier) new BackgroundApplier());
		STYLE_APPLIERS.add((CssApplier) new WidthApplier());
		STYLE_APPLIERS.add((CssApplier) new HeightApplier());
		STYLE_APPLIERS.add((CssApplier) new BorderApplier());
		STYLE_APPLIERS.add((CssApplier) new TextApplier());
	}
