...
public class StringUtils {
    ...
    */
     ...
     */
    public static final String escapeHTMLTags( String input ) throws IOException {
    ...
    public static final String HTMLEncode( String input ) throws IOException {
        //Check if the string is null or zero length -- if so, return
        //what was sent in.
        if( input == null || input.length() == 0 ) {
            return input;
    ...
    */
    ...
    public static final String highlightWords(String string, String[] words,
        String startHighlight, String endHighlight) throws IOException
    {
     ...
     */
    public static final String escapeForXML(String string) throws IOException {
        //Check if the string is null or zero length -- if so, return
        //what was sent in.
