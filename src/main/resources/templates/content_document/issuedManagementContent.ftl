                ...
                <#if listType == 1>
                             <tr No="${key.j}" ItemID="${key.id_}" OrderNumber="${key.OrderNumber}" status="${key.Status}" GlobalID="${key.GlobalID}" id="item_${key.id_}" class="tide_item">
                                 ...
                                 <td class="dropdown hidden-xs-down" >
                                     <a href="javascript:editDocument1_(${key.id_});" class=" btn btn-info btn-sm mg-r-8 mg-b-8 tx-13">查看</a>
                                         ...
                                         <div class="card bd-0">
                                             ...
                                             <div class="card-body bd-t-0 rounded-bottom">
                                                 ...
                                                 <div class="row mg-l-0 mg-r-0 mg-t-5">
                                                     ...
                                                     <#if (key.active == 1) && (canApprove == true) && (userinfo_session.company==0) >
                                                     ...
                                                     <#if (key.active == 0) && (canDelete == true) && (userinfo_session.company==0) >
