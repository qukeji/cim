...
<head>
    ...
    <script>
        ...
        function approve_preview(id,actionId) {
            ...
            window.open("../approve/page?ItemID=" + id + Parameter);
        }
    </script>
</head>
    ...
    <div class="br-pagebody pd-x-20 pd-sm-x-30">
        <div class="card bd-0 shadow-base">
            ...
            <tr>
                ...
                <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-80">内容类型</th>
                <#if IsWeight == 1>
                ...
                <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-70">稿件状态</th>
                ...
                <th class="tx-12-force wd-200 tx-mont tx-medium hidden-xs-down ">操作</th>
            </tr>
            </thead>
            </#if>
                <tbody>
            ...
            <#--<#list map?keys as key>-->
                <#if listType == 1>
                             <tr No="${key.j}" ItemID="${key.id_}" OrderNumber="${key.OrderNumber}" status="${key.Status}" GlobalID="${key.GlobalID}" id="item_${key.id_}" class="tide_item" end="${key.end}" actionId="${key.id_aa}" approve="1" ApproveAction="${key.action}" Editables="${key.editables}">
                                 ...
                                 <td ondragstart="OnDragStart(event)">
                                     ...
                                     <i class="fa fa-picture-o tx-18 tx-primary lh-0 valign-middle" id="img_${key.j}"></i>
                                     <#else >
                                     <i class="icon ion-clipboard tx-22 tx-warning lh-0 valign-middle" id="img_${key.j}"></i>
                                     </#if>
                                     <#if key.TopStatus != 0>
                                 ...
                                 <td class="hidden-xs-down sh-td" data-id="${key.GlobalID}">
                                     <span class="pop-start">${key.approve_status}</span>
                                     <div class="pop-box">
                                 ...
                                 <td class="dropdown hidden-xs-down" >
                                     <a href="javascript:approve_preview(${key.id_},${key.id_aa});" class=" btn btn-info btn-sm mg-r-8 mg-b-8 tx-13">查看</a>
                ...
                <#elseif listType == 2>
                    ...
                    <#if key.m==0>
                             ...
                             <td id="item_${key.id_}" status="${key.Status}" class="tide_item" class="c" end="${key.end}" actionId="${key.id_aa}" approve="1">
                                 <div class="row">
                                     <div class="col-md">
                                         <div class="card bd-0">
                                                     ...
                                                     <label class="ckbox mg-b-0 d-inline-block mg-r-5">
                                                      ...
                                                      <#if userinfo_session.company==0>
                                                         ...
                                                         <a href="javascript:approve2(${key.id_});" class="btn pd-0 mg-r-5" title="发布"><i class="fa fa-cloud-upload tx-18 handle-icon" aria-hidden="true"></i></a>
                                                          ...
                                                          <#if (key.active == 0) && (administrator == true)>
     ...
     <#else >
         ...
         <#if (channel.Attribute1)??>
            ...
            function updateManagerDate(id){
                $.ajax({
                    type: "get",
                    url: "${request.contextPath}/approve/approve_result.jsp?globalid="+id,
