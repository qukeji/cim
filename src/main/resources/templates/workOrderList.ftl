...
<head>
    ...
    <script>
        ...
        {
            var url="${request.contextPath}/admin/workorder_preview?ItemID="+itemid+"&ChannelID=" + ChannelID;
            window.open(url);
        }
...
<div class="br-mainpanel br-mainpanel-file" id="js-source">
    ...
    <div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
        ...
        <div class="btn-group mg-l-auto hidden-sm-down">
            <#if userinfo_session.company gt 0 >
            ...
            <form name="search_form" action="${pageName}?id=${id}&rowsPerPage=${rowsPerPage}" method="post" onsubmit="return check();">
                <div class="row">
                    ...
                    <div class=" mg-lg-t-0 mg-r-10 mg-b-30 search-item">
                        <select class="form-control select2" data-placeholder="分类" name="question_sort">
                            <option label="Choose one"></option>
                            <option value="">全部</option>
                            <option value="0" ${(question_sort=="0")?string('selected','')} >其他</option>
                            <option value="1" ${(question_sort=="1")?string('selected','')} >bug类</option>
                            <option value="2" ${(question_sort=="2")?string('selected','')} >财务类</option>
                        </select>
                    </div>
                ...
                <table class="table mg-b-0 ${(listType==2)?string('table-fixed','')}" id="content-table">
                    <#if listType == 1>
                        ...
                        <tr>
                            ...
                            <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-200">标题</th>
                            <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">所属分类</th>
                            <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">状态</th>

                            <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150 wd-author">提交者</th>
                            <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">提交时间</th>
                    ...
                    <#--<#list map?keys as key>-->
                        <#if listType == 1>
                            <tr No="${key.j}" ItemID="${key.id_}" OrderNumber="${key.OrderNumber}" status="${key.Status}" GlobalID="${key.GlobalID}" id="item_${key.id_}" class="tide_item">
                                ...
                                <td class="valign-middle">
                                    <label><button onclick="javascript:orderReply(${key.id_});" class="btn btn-info btn-sm mg-r-8 tx-13 ">查看</button></label>
                                    <#--                                     <a href="javascript:orderReply(${key.id_});" class="btn pd-0 mg-r-5" title="回复"><i class="fa fa-reply tx-18 handle-icon" aria-hidden="true"></i></a>-->
                                    <#if canDelete == true>
                                        <label><button onclick="javascript:deleteFile1(${key.id_});" class="btn btn-info btn-sm mg-r-8 tx-13">删除</button></label>
                                    </#if>
                                    ...
                                    <#--                                             <#if (key.active == 1) && (canApprove == true)>-->
                                    <#--                                             <a href="javascript:approve2(${key.id_});" class="nav-link">发布</a>-->
                                    <#--                                             </#if>-->
                                    <#--                                             <#if (key.active == 0) && (canDelete == true)>-->
                                    <#--                                             <a href="javascript:resume(${key.id_});" class="nav-link">恢复</a>A-->
                                    <#--                                             <#else>-->
                                    <#--                                                 <a href="javascript:Preview2(${key.id_});" class="nav-link">预览</a>-->
                                    <#--                                                 <a href="javascript:Preview3(${key.id_});" class="nav-link">正式地址预览</a>-->
                                    <#--                                                 <a href="javascript:editDocument(${key.id_});" class="nav-link">编辑</a>-->
                                    <#--                                                 <a href="javascript:deleteFile3(${key.id_});" class="nav-link">撤稿</a>-->

                                    <#--                                                 <#if (channel.RecommendOut)??>-->
                                    <#--                                                 <a href="javascript:recommendOut1(${key.id_});" class="nav-link">推荐</a>-->
                                    <#--                                                 </#if>-->
                                    <#--                                                 <a href="javascript:copy(0);" class="nav-link">复制</a>-->
                                    <#--                                                 <a href="javascript:copy(1);" class="nav-link">移动</a>-->
                                    <#--                                                 <#if IsWeight != 1>-->
                                    <#--                                                 <a href="javascript:SortDoc1(${key.id_});" class="nav-link">排序</a>-->
                                    <#--                                                 </#if>-->
                                    <#--                                                 <#if IsTopStatus = true >-->
                                    <#--                                                 <a href="javascript:CancleTop(${ChannelID},1,${key.id_});" class="nav-link">置顶</a>-->
                                    <#--                                                 <a href="javascript:CancleTop(${ChannelID},2,${key.id_});" class="nav-link">撤销置顶</a>-->
                                    <#--                                                 </#if>-->
                                    <#--                                                 <#if canDelete == true>-->
                                    <#--                                                 <a href="javascript:deleteFile1(${key.id_});" class="nav-link">删除</a>-->
                                    <#--                                                 </#if>-->
                                    <#--                                                 <#if createCategory == true>-->
                                    <#--                                                 <a href="javascript:createCategory(${ChannelID});" class="nav-link">新建分类</a>-->
                                    <#--                                                 </#if>-->
