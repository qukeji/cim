...
<%
   ...
   HashMap<String ,Object> TIDE = new HashMap<String,Object>();
    ...
    TIDE.put("cms_community_topic","channel_community_topic");	            //社区主体内容
    ...
    //TP系统配置
    //juxian金币表配置
    TIDE.put("channel_s53_golddetail","channel_s53_golddetail");                  //金币明细
    TIDE.put("channel_s53_goldaddition","channel_s53_goldaddition");	          //金币加成
