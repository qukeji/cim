...
<%
    ...
    try {
        ...
        if(!RS.next()){
            ...
            map.put("Title",title);
            map.put("password",StringUtils.getMD5(StringUtils.getMD5(password)));
            ...
            if (!password.equals("")){
                ...
                if(!StringUtils.getMD5(StringUtils.getMD5(password)).equals(password1)){
 ...
 //           o.put("appUserInfo",session.getAttribute("appUserInfo"));
            o.put("sessionid",sessionId);
            o.put("avatar",avatar);
            o1.put("result",o);
        ...
        o1.put("status","500");
        o1.put("message","程序异常"+e.toString());
    }
