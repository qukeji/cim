...
<%!
 public HashMap<String, Object> getItems(int type,int pages,int pagesize){
	...
	try{		
		...
		int channelId = jurong.getInt("hotword");//线索汇聚全部16190;

		String type_desc = "";
		if(type==1){
			channelId = jurong.getInt("webHot");//16195;
			type_desc = "网站";
		}else if(type==2){
			channelId = jurong.getInt("weixinHot");//16196;
			type_desc = "微信";
		}else if(type==3){
			channelId = jurong.getInt("weiboHot");//16197;
			type_desc = "微博";
		}
		...
		if(type!=0){
			listSql += " and Category="+channelId;
		}
