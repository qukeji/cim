...
{//查询某个用户最新选题状态，uid是聚现用户编号
	String listSql = "select id,title,summary,publisher,publisher_name,FROM_UNIXTIME(start_time) as start_time,task_status from "+ch.getTableName()+" where User= "+uid+" order by id desc limit 1";
...
String listSql = "select id,title,summary,publisher,publisher_name,FROM_UNIXTIME(start_time) as start_time,task_status from "+ch.getTableName();
