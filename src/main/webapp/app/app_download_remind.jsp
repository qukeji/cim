...
<head>
    ...
    <style>
        ...
        .picture-upload-wrap .picture-preview{width: 110px;min-height: 110px;line-height: 110px;overflow: hidden;}
        .picture-upload-wrap .picture-upload-input{display: none}
        .picture-upload-wrap .load-img{width: 110px;height: 100%;min-height: 110px;line-height: 110px;border: 1px dashed #e5e7e4;text-align: center;cursor: pointer;position: absolute;top: 0;}
                ...
                <div class="row mg-0-force">
                    <div class="col-sm-8 pd-0-force mg-t-20">
                        <%
                            ...
                            while(rs.next()){
                                 ...
                                 AndroidDownload=convertNull(rs.getString("AndroidDownload"));
                                 IosDownload=convertNull(rs.getString("IosDownload"));
                                 }
                                 tu.closeRs(rs);
                        %>
                        <div class="row flex-row align-items-center mg-b-15" id="tr_Title">
                            <label class="left-fn-title wd-150 " id="desc_Title">app名称：</label>
                            <label class="wd-content-lable d-flex wd-sm-table" id="">
                                <input class="form-control" placeholder="" type="text" id="Title" name="Title" size="80" value="<%=Title%>">
                            </label>
                        ...
                        <div class="row flex-row align-items-center mg-b-15" id="tr_PublishDate">
                            <label class="left-fn-title wd-150 " id="desc_PublishDate">客户端logo：：</label>
                        ...
                        <div class="row flex-row align-items-center mg-b-15" id="tr_AndroidDownload">
                            <label class="left-fn-title wd-150 " id="desc_AndroidDownload">安卓下载地址：</label>
                            <label class="wd-content-lable d-flex wd-sm-table" id="">
                                <input class="form-control" placeholder="" type="text" id="AndroidDownload" name="AndroidDownload" size="80" value="<%=AndroidDownload%>">
                            </label>
                            <label><span id="" class="mg-l-10"></span></label>
                        </div>
                        <div class="row flex-row align-items-center mg-b-15" id="tr_IosDownload">
                            <label class="left-fn-title wd-150 " id="desc_IosDownload">IOS下载地址：</label>
                            <label class="wd-content-lable d-flex wd-sm-table" id="">
                                <input class="form-control" placeholder="" type="text" id="IosDownload" name="IosDownload" size="80" value="<%=IosDownload%>">
                            </label>
                            <label><span id="" class="mg-l-10"></span></label>
                        </div> 
                    </div>
                    <div class="col-sm-4 pd-0-force">
                        ...
                        <div class="app-img-box">
                            <img src="../images/appconfig/appdownload.png">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function subfrom() {
        $.ajax({
            url:"app_download_remind_submit.jsp",
            type: 'post',
