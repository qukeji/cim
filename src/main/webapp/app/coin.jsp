...
String ListSql = "select id,Title,Weight,GlobalID,User,userid,coins,Photo,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews";
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">增加金币</th>
							<%if(IsComment==1){%>
