...
String ListSql = "select id,Title,Photo,Photo2,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews";
...
%>
		...
		<div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
			...
			<div class="dropdown hidden-sm-up">
				...
				<div class="dropdown-menu pd-10">
					<nav class="nav nav-style-1 flex-column">
						...
						<a href="javascript:list('Status1=-1');" class="nav-link list_draft">已撤销</a>
						<a href="javascript:list('Status1=1');" class="nav-link list_publish">已生效</a>
			...
			<div class="btn-group mg-l-10 hidden-xs-down">
				...
				<a href="javascript:list('Status1=-1');" class="btn btn-outline-info list_draft">已撤销</a>
				<a href="javascript:list('Status1=1');" class="btn btn-outline-info list_publish">已生效</a>
			...
			<div class="btn-group mg-l-auto hidden-sm-down">
				...
				<%}%>
					...
					<a href="javascript:deleteFile2();" class="btn btn-outline-info">撤销</a>
			...
			<div class="dropdown mg-l-auto hidden-md-up">
				...
				<div class="dropdown-menu dropdown-menu-right pd-10">
					<nav class="nav nav-style-1 flex-column">
						...
						<a href="javascript:deleteFile2();" class="nav-link">撤销</a>
						<%if(!channel.getRecommendOut().equals("")){%>
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-80">已读图标</th>
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-80">未读图标</th>
...
while(Rs.next())
{
	...
	int TopStatus = 0;
	String Photono=convertNull(Rs.getString("Photo"));
...
%>
		<tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>" status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item">
			...
			<td class="hidden-xs-down">
				<img style="Weight:26px;height:26px"src=<%=Photono%>>
			</td>
				<td class="hidden-xs-down">
		    <img style="Weight:26px;height:26px"src=<%=Photo2%>>
			</td>
			<td class="hidden-xs-down">
				<%=ModifiedDate%>
			</td>
				...
				<div class="dropdown-menu dropdown-menu-right pd-10">
					<nav class="nav nav-style-1 flex-column">
						...
						<%}else{%>
							...
							<a href="javascript:deleteFile3(<%=id_%>);" class="nav-link">撤销</a>
							<%if(!channel.getRecommendOut().equals("")){%>
		...
		<div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
			...
			<div class="dropdown hidden-sm-up">
				...
				<div class="dropdown-menu pd-10">
					<nav class="nav nav-style-1 flex-column">
						<a href="javascript:list();" class="nav-link list_all">全部</a>
						<a href="javascript:list('Status1=-1');" class="nav-link list_draft">已撤稿</a>
						<a href="javascript:list('Status1=1');" class="nav-link list_publish">已生效</a>
						<a href="javascript:list('IsDelete=1');" class="nav-link list_delete">已删除</a>
						<a href="#" class="nav-link">搜索</a>
					</nav>
...
*/			
		...
		<%if(active==0 && userinfo_session.isAdministrator()){%>
			...
			<%}%>	
		<%if(canApprove){%>
			{'<i class="fa fa-cloud-upload tx-18 handle-icon"></i>生效':function(menuItem,menu) {approve();} },
		<%}%>
			
			{'<i class="fa fa-arrow-down mg-r-5 fa"></i>撤销':function(menuItem,menu) {deleteFile2(); }},
