...
String ListSql = "select id,Title,Weight,GlobalID,User,Photo,userid,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews";
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">关注用户</th>
				...
				<div class="card bd-0">
					...
					<div class="card-body bd-t-0 rounded-bottom">
					  ...
					  <div class="row mg-l-0 mg-r-0 mg-t-5">				                  					                  
						  ...
						  <%}else{%>
						  <a href="javascript:Preview2(<%=id_%>);" class="btn pd-0 mg-r-5" title="预览"hidden="hidden"  hidden="hidden"><i class="fa fa-search tx-18 handle-icon" aria-hidden="true"></i></a>
