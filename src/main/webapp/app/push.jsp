...
String ListSql = "select id,Title,Photo,Weight,GlobalID,Content,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews";
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-mediu" >推送内容</th>
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-120 wd-author">推送时间</th>
							<%if(IsComment==1){%>
