...
String ListSql = "select id,Title,Weight,GlobalID,User,zancount,Photo,userid,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews,user_ip";
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">用户</th>
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">用户IP</th>
							<th class="tx-12-force tx-mont tx-medium  hidden-xs-down wd-150">点赞数</th>
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-150">发布时间</th>
