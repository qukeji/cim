	...
	try{
		if(optype.equals("agree"))
		{
			for(int i = 0;i<itemid_.length;i++){
				...
				String Audit_nickname = doc.getValue("Audit_nickname");
				sql = "update "+ tablename+" set Title='"+Audit_nickname+"' where id =" + Userid;
				sql1 = "update "+ tablename1+" set Status1=1 where Userid =" + Userid + " and Status1=0";

				sql_zuhu = "update "+ tablename_zuhu+" set Title='"+Audit_nickname+"' where id =" + Userid;
