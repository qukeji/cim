...
if(!Submit.equals(""))
{
	...
	ApproveScheme as = new ApproveScheme();

	as.setTitle(Title);
	as.setUserId(userinfo_session.getId());
	//as.setEditable(editable);
	as.setCompany(userinfo_session.getCompany());
	as.Add();
...
<body class="" >
    <div class="bg-white modal-box">
	  <form name="form" action="approve_scheme_add.jsp" method="POST" onSubmit="return check();">     
	        ...
	        <div class="config-box">	
               <ul>
					...
					<div class="row">                   		  	  	
						...
						<label class="wd-300">
							<input name="Title" size="32" class="form-control" placeholder="" type="text" value="">
						</label>									            
					</div>
				  </li>       
	       	  </ul>             	
