...
//如果是“新建应用”；
    ...
    System.out.println(canList+""+onlyMe);
...
// out.println(ListSql);
    ...
    <div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
        ...
        <div class="btn-group mg-l-auto hidden-sm-down">
            ...
            <%if (createCategory&&userinfo_session.getCompany()==0&&userinfo_session.getRole()==1) {%>
            <a href="javascript:createCategory(<%=ChannelID%>);"
               class="btn btn-outline-info hidden-md-1500-down">新建分类</a>
            <%}%>
            ...
            <table class="table mg-b-0 <%=listType==2?"table-fixed":""%>" id="content-table">
                ...
                <tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>" status="<%=Status%>"
                    ...
                    <td class="dropdown hidden-xs-down">
                        ...
                        <%}%>
                        <a href="javascript:approve_preview(<%=id_%>,<%=id_aa%>);" class="btn pd-0 mg-r-5" title="审核预览"><i
