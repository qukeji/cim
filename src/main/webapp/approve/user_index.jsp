...
<script> 
	...
	function ok(){
		...
		top.TideDialogClose({suffix:'_3',recall:true,returnValue:{users:userId,Usernames:Username}});
	}
...
<div class="bg-white modal-box"> 
	...
	<div class="btn-box">
      	<div class="modal-footer" >
		     ...
		     <button id="btnCancel1" name="btnCancel1" type="button" onclick="top.TideDialogClose({suffix:'_3'});" class="btn btn-secondary tx-size-xs" data-dismiss="modal">取消</button>
		</div> 
    </div>
</div>
</body>
...
<script>
	...
	function showUser(id){
		$.ajax({
			type:"GET",
			dataType:"json",
			url:"../report/getUserList.jsp?GroupID="+id+"&users="+users,
