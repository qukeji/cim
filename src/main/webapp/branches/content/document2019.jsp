...
#col-sm-5 .pd-x-0-force{background:#fff}
#col-sm-5 {background:#fff}
.pd-x-0-force {padding-left: 8px!important; padding-right: 8px!important;}
.br-pagebody {margin-top: 20px;}
#col-sm-5.pd-x-0-force{border-right: 20px solid #e9ecef;border-left: 20px solid #e9ecef;}
#col-sm-5{overflow-y:auto}
/*滚动条样式美化*/
/*#col-sm-5::-webkit-scrollbar {width:9px;height:9px;}
#col-sm-5::-webkit-scrollbar-track {width: 6px;background-color:#fff;-webkit-border-radius: 2em;-moz-border-radius: 2em;border-radius:2em;}
#col-sm-5::-webkit-scrollbar-thumb {background-color:#ccc;background-clip:padding-box;min-height:28px;-webkit-border-radius: 2em;-moz-border-radius: 2em;border-radius:2em;}*/
/*滚动条移上去的背景*/
/*#col-sm-5::-webkit-scrollbar-thumb:hover {background-color:#e9ecef;}*/
.ds_tr{display:none}
...
#col-sm-5 .br-pagebody input[type='text']{min-width:200px;}
/*.col-sm-4 .br-pagebody  input[type='text']#href_app,.col-sm-4 .br-pagebody  input[type='text']#Photo3 {min-width: 138px;margin-left: 39px;}
.col-sm-4 .br-pagebody  input[type='text']#Photo4,.col-sm-4 .br-pagebody  input[type='text']#Photo2{min-width: 80px;margin-left: 13px;}*/

#withSecondNav{overflow-y:auto}
#withSecondNav::-webkit-scrollbar{display:none}
...
<script>
 ...
 //结构栏:
      Html = ''
       ...
       +'<div  class="col-sm-7 pd-r-0-force colapprove item_left" id="item_left">'
       +'</div>'
       +'<div class="col-sm-5 pd-x-0-force" id="col-sm-5">'
       ...
       +'</div>'
              ...
              document.getElementById('col-sm-5').style.height= (window.screen.availHeight/1-190)+"px";
...
function conetntTitle(list,org,main,holder){
        var   s = ""
              ...
              +'<div class="d-flex">'
              +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="tr_Title">'+list+'</div>'
...
function  PublishDate(description,value,main){
 ...
 //var  time =    timestampToTime(value);
    ...
    var str = ''
        ...
        +'<div class="d-flex">'
	    +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400">'+description+'</div>'
	    +'<div class="d-flex align-items-center justify-content-center wd-200 ht-70 bg-gray-400 mg-l-20 items-list" >'
	    +'<input type="text" name="PublishDate" id="PublishDate" value="'+getNowFormatDate()+'"    class="textfield date form-control hasDatepicker" size="">'
        +'</div>'
	    +'</div>'
	    +'</div>'
	    $(main).append(str)
...
function Weight(description,value,holder,main){
   var str = ''
        ...
        +'<div class="d-flex">'
	    +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400">'+description+'</div>'
	    +'<div class="d-flex align-items-center justify-content-center wd-200 ht-70 bg-gray-400 mg-l-20">'
	    +'<input type="text" name="Weight" id="Weight" value="'+value+'"  placeholder="'+holder+'"   class="textfield date form-control hasDatepicker" >'
        +'</div>'
	    +'</div>'
	    +'</div>'
	    $(main).append(str) 
...
function Summary(description,value,main){
   var str = ''
       ...
       +'<div class="d-flex">'
       +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_Summary">'+description+'</div>'
       +'<div class="d-flex align-items-center justify-content-center wd-200 ht-70 bg-gray-400 mg-l-20"  id="field_Summary">'
...
function  SetPublishDate(list,value,main){
    var str = ''
       ...
       str+='<div class="row flex-row align-items-center mg-b-15" id="tr_SetPublishDate">'
         +'<div class="d-flex">'
        +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_SetPublishDate">'+list+'</div>'
        +'<div class="d-flex align-items-center justify-content-center wd-200 ht-70 bg-gray-400 mg-l-20"   id="field_SetPublishDate">'
...
function IsPhotoNews(description,value,main){
    ...
    str+='<div class="row flex-row align-items-center mg-b-15" id="tr_IsPhotoNews" >'
       +'<div class="d-flex">'
       +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_IsPhotoNews">'+description+'</div>'
       +'<div class="d-flex align-items-center justify-content-left wd-200 ht-70 bg-gray-400 mg-l-20" id="field_IsPhotoNews">'+'<label class="ckbox">'
...
function Photo(description,value,main,list){
    ...
    var str =''
        str+='<div class="row flex-row align-items-center mg-b-15"  id="tr_Photo">'
         +'<div class="d-flex">'
         +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_Photo">'+description+'</div>'
         +'<div class="d-flex align-items-center justify-content-center felx-1 ht-70 bg-gray-400 mg-l-20"  id="field_Photo">'+'<input type="text" name="Photo" id="Photo" value="'+value+'" class="textfield upload field_image form-control" title=""  data-original-title="" >'
         +'</div>'+'<div  class="d-flex align-items-center justify-content-center wd-100 ht-70 bg-gray-400 mg-l-20">'
        +'<input type="button" value="选择"   class="btn btn-primary tx-size-xs mg-l-5 xz">'
         +'<input type="button" value="预览" onclick="" class="btn btn-primary tx-size-xs mg-l-5 "  id="demo_yl"  style="margin-left:5px">'
         +'</div>'+'</div>'+'</div>'
  $(main).append(str) 
  //预览方法
...
function Keyword(description,value,main,list){
    var str =''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_Keyword">'
          +'<div class="d-flex">'
        +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_Keyword">'+description+'</div>'
        +'<div class="d-flex align-items-center justify-content-right felx-1 ht-70 bg-gray-400 mg-l-20" id="field_Keyword">'
        //tagit-hidden-field
        +'<input type="text" class="textfield form-control "  name="Keyword" id="Keyword" value="'+value+'" >'
        +'</div>'
        +'<div class="d-flex align-items-center justify-content-center wd-70 ht-70 bg-gray-400 mg-l-20">'
...
function list(description,lists,values,main){
  var str =""
      str+='<div class="row flex-row align-items-center mg-b-15" id="tr_item_type" style="display: flex;flex-wrap: nowrap; justify-content: space-between;">'
          +'<div class="d-flex" style="">'
          +'<div  class="d-flex align-items-center justify-content-left wd-80  bg-gray-400" id="desc_item_type">'+description
          ...
          +'<div class="d-flex align-items-center justify-content-left flex-1  bg-gray-400 mg-l-20 wd-content-ckx d-flex"   id="field_item_type" >'
...
function content_type(description,value,main){
      var str =''
          str+='<div class="row flex-row align-items-center mg-b-15" id="tr_content_type">'
            +'<div class="d-flex">'
            +'<div  class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_content_type" style="margin-right:0">'+description+'</div>'
...
function doc_type(description,lists,values,main){
    var str =""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_doc_type" style="display: flex;flex-wrap: nowrap;justify-content: space-between;">'
        +'<div class="d-flex  d-flextr_doc" style=>'
           +'<div  class="d-flex align-items-center justify-content-left wd-80  bg-gray-400"  id="desc_doc_type" >'+description
         +'<input type="text"   value="'+values+'" id="td_doc_type"  class="ds_tr">'
           +'</div>'
           +'<div class="d-flex align-items-center justify-content-left flex-1  bg-gray-400 mg-l-20 wd-content-ckx d-flex"   id="field_doc_type">'
   for(var j = 0;j<lists.length;j++){
   var name = lists[j][0]
   var reg = /[\u4e00-\u9fa5]/g;
...
function showbuttontitle(description,lists,values,main){
   var str =''
       str+='<div class="row flex-row align-items-center mg-b-15" id="tr_showbuttontitle"  style="display: flex;flex-wrap: nowrap;">'
      +'<div class="d-flex">'
       +'<div  class="d-flex align-items-center justify-content-left wd-80  bg-gray-400"  id="desc_showbuttontitle">'+description+'</div>'
       +'<input type="text"   value="'+values+'" id="td_tontitle" class="ds_tr">'
       +'<div class="d-flex align-items-center justify-content-left felx-1  bg-gray-400 mg-l-20" id="field_showbuttontitle">'
       for(var j = 0;j<lists.length;j++){
       str+='<label class="rdiobox mg-r-15">'
...
function anuor(description,value,main){
  var str =""
      str+='<div class="row flex-row align-items-center mg-b-15" id="tr_anuor">'
         +'<div class="d-flex">'
         +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_anuor">'+description+'</div>'
...
function isAudio(description,lists,values,main){
   var str =''
       str+='<div class="row flex-row align-items-center mg-b-15" id="tr_isAudio">'
        +'<div class="d-flex">'
           +'<div  class="d-flex align-items-center justify-content-left wd-80 bg-gray-400" id="desc_isAudio">'+description+'</div>'
           +'<div  class="d-flex align-items-center justify-content-left flex-1  bg-gray-400 mg-l-20" id="field_isAudio">'
...
function videoid(description,value,main){
    var str=""
        ...
        +'<div class="d-flex">'
        +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_videoid">'+description+'</div>'
...
//视频类型:
      function  mediatype(description,value,main){
          var str =''
              ...
              +'<div class="d-flex">'
              +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_mediatype">'+description+'</div>'
...
function epgchannelid(description,value,main){
    var str =''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_epgchannelid">'
          +'<div class="d-flex">'
          +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_epgchannelid">'+description+'</div>'
...
function href_app(description,value,main){
    var str = ''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_href_app">'
            +'<div class="d-flex">'
            +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_href_app">'+description+'</div>'
            +'<div class="d-flex align-items-center justify-content-center flex-1  ht-70 bg-gray-400 mg-l-20" id="field_href_app" style="">'
            +'<input type="text" class="textfield form-control" name="href_app" id="href_app"  value="'+value+'" style="min-width:200px">'
           +'</div>'
           +'<div class="d-flex align-items-center justify-content-right wd-80 ht-70 bg-gray-400 ">'
           +'<input type="button" value="预览" onclick="" class="btn btn-primary tx-size-xs mg-l-10 app_list" style="">'
           +'</div>'
           +'</div>'
            +'</div>'
           $(main).append(str)  
...
function Photo4(description,value,main){
    var str = ""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_Photo4">'
          +'<div class="d-flex">'
           +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_Photo4">'+description+'</div>'
           +'<div class="d-flex align-items-center justify-content-center flex-1  ht-70 bg-gray-400 mg-l-20" id="field_Photo4">'
           +'<input type="text" name="Photo4" id="Photo4" value="'+value+'" class="textfield upload field_image form-control" title=""  data-original-title="">'
           +'</div>'+'<div  class="d-flex align-items-center justify-content-center wd-100 ht-70 bg-gray-400 mg-l-20" style="margin-left:14px">'
           +'<input type="button" value="选择" onclick="" class="btn btn-primary tx-size-xs mg-l-5 Photo4_xz" >'
           +'<input type="button" value="预览" onclick="" class="btn btn-primary tx-size-xs mg-l-5 Photo4_yl">'
           +'</div>'+'</div>'+'</div>'
         $(main).append(str)
         //选择:
...
function Photo2(description,value,main){
    var str = ''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_Photo2">'
          +'<div class="d-flex">'
          +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_Photo2">'+description+'</div>'
          +'<div class="d-flex align-items-center justify-content-center felx-1 ht-70 bg-gray-400 mg-l-20" id="field_Photo2">'
          +'<input type="text" name="Photo2" id="Photo2" value="'+value+'" class="textfield upload field_image form-control" title=""  data-original-title="">'
          +'</div>'+'<div  class="d-flex align-items-center justify-content-center wd-100 ht-70 bg-gray-400 mg-l-20" style="margin-left:13px">'+'<input type="button" value="选择" onclick="" class="btn btn-primary tx-size-xs mg-l-5 Photo2_xz">'+'<input type="button" value="预览" onclick="" class="btn btn-primary tx-size-xs mg-l-5 Photo2_yl">'
          +'</div>'+'</div>'+'</div>'
           $(main).append(str)
         //选择:
...
function Photo3(description,value,main){
      var str = ''
          str+='<div class="row flex-row align-items-center mg-b-15" id="tr_Photo3">'
             +'<div class="d-flex">'
             +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_Photo3">'+description+'</div>'
             +'<div class="d-flex align-items-center justify-content-center flex-1  ht-70 bg-gray-400 mg-l-20"  id="field_Photo3">'
             +'<input type="text" name="Photo3" id="Photo3" value="'+value+'" class="textfield upload field_image form-control" title=""  data-original-title="">'
             +'</div>'+'<div class="d-flex align-items-center justify-content-right wd-80 ht-70 bg-gray-400">'+'<input type="button" value="选择" onclick="" class="btn btn-primary tx-size-xs mg-l-10  Photo3_xz">'+'<input type="button" value="预览" onclick="" class="btn btn-primary tx-size-xs mg-l-10  Photo3_yl" style="margin-left:5px>'
             +'</div>'+'</div>'+'</div>'
        $(main).append(str)
         //选择:
...
function videourl(description,value,main){
      var str = ''
          str+='<div class="row flex-row align-items-center mg-b-15" id="tr_videourl">'
            +'<div class="d-flex">'
             +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_videourl">'+description+'</div>'
...
function td_liveid(description,value,main){
    var str =""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_td_liveid">'
          +'<div class="d-flex">'
        +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_td_liveid">'+description+'</div>'
...
function juxian_liveid(description,value,main){
     var str =''
         str+='<div class="row flex-row align-items-center mg-b-15" id="tr_juxian_liveid">'
            +'<div class="d-flex">'
            +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_juxian_liveid">'+description+'</div>'
...
function secondcategory(description,value,main){
     var str =''
         str+='<div class="row flex-row align-items-center mg-b-15" id="tr_secondcategory">'
             +'<div class="d-flex">'
            +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_secondcategory">'+description+'</div>'
...
function frame(description,lists,values,main){
    var str = ''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_frame" style="display: flex;flex-wrap: nowrap;">'
          +'<div class="d-flex" style="">'
          +'<div  class="d-flex align-items-center justify-content-left wd-80  bg-gray-400" id="desc_frame">'+description+'</div>'
          +'<input type="text"   value="'+values+'" id="tr_frame"  class="ds_tr">'
          +'<div class="d-flex align-items-center justify-content-left flex-1  bg-gray-400 mg-l-20 wd-content-ckx d-flex" id="field_frame">'
    for(var j = 0;j<lists.length;j++){
          var name = lists[j][0]
          var reg = /[\u4e00-\u9fa5]/g;
          var names = name.match(reg);
...
function pv_virtual(description,value,main){
    var str =''
        ...
        +'<div class="d-flex">'
        +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_pv_virtual">'+description+'</div>'
...
function pv(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_pv">'
          +'<div class="d-flex">'
           +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_pv">'+description+'</div>'
...
function allowcomment(description,value,main){
    var str = ''
       str+='<div class="row flex-row align-items-center mg-b-15" id="tr_allowcomment" style="display: flex;flex-wrap: nowrap;">'
          +'<div class="d-flex">'
           +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_allowcomment" style="">'+description+'</div>'
           +'<div class="d-flex align-items-center justify-content-left wd-200 ht-70 bg-gray-400 mg-l-20" id="field_allowcomment"   >'
...
function showread(description,value,main){
   var str =''
       str+='<div class="row flex-row align-items-center mg-b-15" id="tr_showread" style="display: flex;flex-wrap: nowrap;">'
         +'<div class="d-flex">'
           +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_showread">'+description+'</div>'
           +'<div  class="d-flex align-items-center justify-content-left wd-200 ht-70 bg-gray-400 mg-l-20" id="field_showread">'
...
function allowadvert(description,value,main){ 
             var str =''
                 str+='<div class="row flex-row align-items-center mg-b-15" id="tr_allowadvert"  style="display: flex;flex-wrap: nowrap;">'
                   +'<div class="d-flex">'
                    +'<div  class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_allowadvert">'+description+'</div>'
                    +'<div  class="d-flex align-items-center justify-content-left wd-200 ht-70 bg-gray-400 mg-l-20"  id="field_allowadvert">'
...
function zanvirtualnum(description,value,main){
    var str = ''
           str+='<div class="row flex-row align-items-center mg-b-15" id="tr_zan_virtual_num">'
            +'<div class="d-flex">'
            +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_zan_virtual_num">'+description+'</div>'
...
function  baoliaostatus(description,lists,values,main){
      var str = ''
       str+='<div class="row flex-row align-items-center mg-b-15" id="tr_baoliaostatus" style="display:flex;flex-wrap: nowrap;">'
         +'<div class="d-flex">'
        +'<div  class="d-flex align-items-center justify-content-left wd-80  bg-gray-400"  id="desc_baoliaostatus">'+description+'</div>'
        +'<input type="text"   value="'+values+'" id="tr_atus"  class="ds_tr">'
        +'<div class="d-flex align-items-center justify-content-left felx-1  bg-gray-400 mg-l-20 wd-content-ckx d-flex"   id="field_baoliaostatus">'
         for(var j = 0;j<lists.length;j++){
         var name = lists[j][0]
         var reg = /[\u4e00-\u9fa5]/g;
        var names = name.match(reg);
...
function  baoliao_ispublic(description,lists,values,main){
 var str = ''
     str+='<div class="row flex-row align-items-center mg-b-15" id="tr_baoliao_ispublic"  style="display: flex;flex-wrap: nowrap;">'
        +'<div class="d-flex">'
        +'<div  class="d-flex align-items-center justify-content-left wd-80  bg-gray-400"  id="desc_baoliao_ispublic">'+description+'</div>'
        +'<input type="text"   value="'+values+'" id="baoliao"  class="ds_tr">'
        +'<div  class="d-flex align-items-center justify-content-left felx-1  bg-gray-400 mg-l-20"  id="field_baoliao_ispublic">'
            for(var j = 0;j<lists.length;j++){
         var name = lists[j][0]
         var reg = /[\u4e00-\u9fa5]/g;
         var names = name.match(reg);
...
function baoliao_localtion(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_baoliao_localtion">'
            +'<div class="d-flex">'
            +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_baoliao_localtion">'+description+'</div>'
...
function jd(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_jd">'
          +'<div class="d-flex">'
          +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_jd">'+description+'</div>'
...
function wd(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_wd">'
          +'<div class="d-flex">'
            +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400"  id="desc_wd">'+description+'</div>'
...
function baoliao_userid(description,value,main){
     var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_baoliao_userid">'
           +'<div class="d-flex">'
           +'<div class="d-flex align-items-center justify-content-left wd-80 ht-70 bg-gray-400" id="desc_baoliao_userid">'+description+'</div>'
...
//form2中样式处理：
setTimeout(function(){
  $("#form2 .wd-200,#form2 .wd-70,#form2 #field_Keyword").css({'width':'400px'})
  $("#form2 #tr_Keyword .d-flex.align-items-center.justify-content-center.wd-70.ht-70.bg-gray-400.mg-l-20").css({'width':'68px'})
  $("#form2 #field_Photo").css({'width':'400px'})
},1000)
...
var screenWd = document.documentElement.clientWidth
if(screenWd > 1400 ){
    //左侧布局
    $("#col-sm-5").removeClass('col-sm-5')
    $("#col-sm-5").addClass('col-sm-4')
    //$("#col-sm-5 .br-pagebody input[type='text']").css({'min-width':'120px'})
   // $("#href_app,#Photo4,#Photo3").css({'min-width':'160px'})
   //$(".mg-l-20").css({'margin-left':'10px'})
    $(".wd-80").css({'width':'56px'})
    $(".item_right").css({'margin-left':'-17px'})
    //右侧布局
    $("#item_left").removeClass('col-sm-7')
    $("#item_left").addClass('col-sm-8')
}
},1000)
