...
String fieldidName = getParameter(request,"fieldidName");
...
String ListSql = "select id,Title,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews,state";
...
//if(!S_User.equals(""))
	...
	ListSql += " where task_status=1 and Active=" + IsActive;
	CountSql += " where task_status=1 and Active=" + IsActive;
...
if(user_id>0){
	WhereSql += " and user_id like %"+users_id+"%";
}
