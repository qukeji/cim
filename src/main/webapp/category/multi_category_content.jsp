      ...
      <div class="br-pagebody pd-x-20 mg-t-25" id="category">
      	<div class="d-flex align-items-center justify-content-start mg-b-20">
	        <div class="btn-group mg-l-auto hidden-sm-down">
				...
				<a href="javascript:multi_add();" class="btn btn-outline-info"><i class="fa fa-plus mg-r-3"></i>新建子分类</a>			
...
function multi_add_new()
{
	...
	//跳转添加第一级jsp处理
	var url="../category/multi_category_add_new2018.jsp?itemid="+itemid+"&channelid="+ChannelID+"&level="+level;
...
function multi_add()
{
	...
	{
		//跳转到添加子分类jsp进行处理
		var url="../category/multi_category_add2018.jsp?itemid="+itemid+"&channelid="+ChannelID+"&level="+level;
		var	dialog = new top.TideDialog();
		dialog.setWidth(460);
		dialog.setHeight(240);
		dialog.setUrl(url);
