...
if(haschild!=0 || level_==0)
{
	...
	while(rs.next())
	{
		...
		//if(hasN == 0)
		//{
			str +="<li class=\"no_arrow\" hasNext=\""+hasN+"\" itemid=\""+itemid+"\" parent=\""+Parent+"\" level=\""+Level+"\" globalid=\""+gid+"\"  ondblclick=\"selectContent(this,\'"+field+"\')\">"+Title+"</li>";
		//} 
		//else
		//{
		//	str +="<li class=\"\" hasNext=\""+hasN+"\" itemid=\""+itemid+"\" parent=\""+Parent+"\" level=\""+Level+"\" globalid=\""+gid+"\">"+Title+"</li>";
		//}
	}
	str += "</ul></div>";
	out.println(str);
