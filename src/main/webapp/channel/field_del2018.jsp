...
String Name = getParameter(request,"FieldName");
int	fid = getIntParameter(request,"fid");
...
<html lang="en">
 ...
 <form name="form" method="post" action="field_del2018.jsp" >     
	    <div class="modal-body modal-body-btn pd-20 overflow-y-auto">
	        <div class="config-box mg-t-15">
	   		  	<div class="row">                   		  	  	
		  	  		  <label class="left-fn-title">你确定要删除字段<%=Name%>吗?</label>							            
	   		  	</div>	
                 <div class="row">                              				
