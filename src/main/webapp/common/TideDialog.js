function TideDialog(){
	...
	this.show=function(){
		...
		var $popDiviframe=jQuery(dialogid + " .openwin_iframe");
...
function TideDialogInit(o)
{
	...
	*/
	var html='<div class="openwin tidedialog" id="TideDialog'+o.suffix+'" style="display:none;"><div class="openwin_bg"></div><div class="openwin_main" id="popmain'+o.suffix+'">\
		<div class="openwin_nav" id="openwin_nav_id">\
			...
			<div class="close" style="background:url('+o.img+') no-repeat 0 0;"><a style="cursor:pointer;" title="关闭" class="TideDialogClose"></a></div>\
		</div>\
