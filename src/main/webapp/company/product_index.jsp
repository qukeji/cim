...
<body class=" email"  onLoad="init();">
    ...
    <div class="br-mainpanel with-first-nav">
        <iframe src="product_content.jsp" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
	...
	<script>	
        ...
        $(function(){
			...
			$("#system-menu-cms-product-manage").addClass("active");
