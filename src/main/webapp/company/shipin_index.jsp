...
<%
    ...
    int channel_shipingid=8800;//视频频道id
    String dir = "video";
...
//			this.location = "../user/group_delete2018.jsp?Action=Delete&id="+GroupID;
                    ...
                    $.ajax({
                        type: "GET",
                        dataType: "json",
                        url: "renwu_content.jsp?Action=Delete&id=" + GroupID,
...
<div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
    <iframe src="/vms/index_tcenter.jsp?url=/vms/video/myvideo/shipin_content.jsp?id=<%=channel_shipingid%>&userId=<%=userId%>" id="content_frame" style="width: 100%;height: 100%;" frameborder="0"
