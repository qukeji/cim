...
<script src="../lib/2018/jquery-contextMenu/js/jquery.ui.position.min.js"></script>-->
    ...
    <script>
        ...
        var Parameter = "&ChannelID=" + ChannelID + "&rowsPerPage=" + currRowsPerPage + "&currPage=" + currPage+"&mytopic=1";
...
// out.println(ListSql);
    ...
    <div class="search-box pd-x-20 pd-sm-x-30" style="display:none;">
        <div class="search-content bg-white">
            <form name="search_form" action="<%=pageName%>?id=<%=id%>&mytopic=1&rowsPerPage=<%=rowsPerPage%>" method="post"
