...
if(channel.getListProgram().length()>0 && uri.endsWith("/content/wo_content.jsp"))
	...
	<div class="br-mainpanel br-mainpanel-file" id="js-source">
		<div class="br-pageheader pd-y-15 pd-md-l-20">
			<nav class="breadcrumb pd-0 mg-0 tx-12">
				<span class="breadcrumb-item active">工单管理</span>
			</nav>
		</div>
		<!-- br-pageheader -->
<%
...
%>
		...
		<div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
			...
			<div class="btn-group mg-l-10 hidden-xs-down">
				...
				<a href="javascript:list('Status1=-1');" class="btn btn-outline-info list_draft">待处理</a>
				<a href="javascript:list('Status1=1');" class="btn btn-outline-info list_publish">处理中</a>
				<a href="javascript:list('IsDelete=1');" class="btn btn-outline-info list_delete">已关闭</a>
				<a href="#" class="btn btn-outline-info btn-search">搜索</a>
			</div>
			<!-- btn-group -->

			<div class="btn-group mg-l-auto hidden-sm-down">
				<a href="javascript:addWork();" class="btn btn-outline-info">新建</a>
				<a href="javascript:;" class="btn btn-outline-info">回复</a>
				<a href="javascript:;" class="btn btn-outline-info">查看</a>
				<a href="javascript:;" class="btn btn-outline-info">撤单</a>
				<a href="javascript:;" class="btn btn-outline-info">关闭</a>
			</div>
