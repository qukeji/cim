			...
			<div class="d-flex ht-100p-force justify-content-between">
				...
				<div class="right-box wd-700">
					<div id="rightTd" style="height: 100%;">      
						<iframe src="company_topic_right.jsp?id=<%=ChannelID%>" name="right" id="right" style="width: 100%;height: 100%;" scrolling="auto" frameborder="0"></iframe>
					</div>
				</div><!-- right-box -->
...
//========================================================================
		$.sidebarMenu = function(menu) {
			...
			$(menu).on('click', 'li a', function(e) {
				...
				window.frames["right"].location = "company_topic_right.jsp?id="+channelid+"&doc_type=<%=doc_type%>";
			});
		}	
	</script>
</body>
