				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<%if(IsWeight==1){%>
							<th class="tx-12-force tx-mont tx-medium  wd-40">权重</th>
							<%}%>
							<th class="tx-12-force tx-mont tx-medium  wd-60">状态</th>
							<th class="tx-12-force tx-mont tx-medium  wd-60">日期</th>
							<th class="tx-12-force tx-mont tx-medium  wd-80 wd-author">作者</th>
							<%if(IsComment==1){%>
							<th class="tx-12-force tx-mont tx-medium  wd-40">评论</th>
							<%}%>
							<%if(IsClick==1){%>
							<th class="tx-12-force tx-mont tx-medium  wd-40">点击量</th>
							<%}%>
							<th class="tx-12-force tx-mont tx-medium wd-150">操作</th>
						</tr>
					</thead>
                  <%}%>
					<tbody>
