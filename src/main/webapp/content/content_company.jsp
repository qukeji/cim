...
//获取频道路径
String parentChannelPath = channel.getParentChannelPath();
parentChannelPath = parentChannelPath.replaceAll(">"," / ");//.substring(0,parentChannelPath.lastIndexOf(">"))
%>
<!DOCTYPE html>
<html>
<head>
...
%>
		...
		<div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
			...
			<div class="btn-group mg-l-auto hidden-sm-down">
				...
				<%if(IsWeight!=1){%>
					<a href="javascript:sortableEnable();" class="btn btn-outline-info hidden-md-1500-down">排序</a>
				<%}%>
				<%if(IsTopStatus){%>
