...
String ListSql = "select id,Title,phone,avatar,IP,siteflag,wechat,weibo,Photo,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,FROM_UNIXTIME(PublishDate) as PublishDate,Status,Active,Category,IsPhotoNews";
