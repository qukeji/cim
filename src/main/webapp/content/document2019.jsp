            ...
            $.ajax({  
                    ...
                    success :function(data) {
                          ...
                          for(var i = 0;i < data.form.length;i++){
                              tabSection(data.form[i].id,data.form[i].name,data.form[i].name,'.sidebar-label',i+1)
                          }
                          //内容返回判断：
                             ...
                             for(var i = 0; i<item[1].fields.length; i++){
                              ...
                              if(item[1].fields[i].name=='PublishDate'){
                                  ...
                                  //来源：
                                   ...
                                   //定时发布：
                                   SetPublishDate(item[1].fields[i].description,item[1].fields[i].value,data.form[1].fields[i].fieldTypeDesc,'#form2')
...
function conetntTitle(list,org,main,holder){
        var   s = ""
			  ...
			  +'<label class="left-fn-title" id="tr_Title">'+list+'</label>'
			  +'<label class="d-flex" id="field_Title">'
			  +'<input class="form-control" placeholder="'+holder+'" type="text" id="Title" name="Title" size="80" value="'+org+'" onkeyup="checkTitle();" >'
			  +'</label>'
			  +'<label>'
			  +'<span id="TitleCount" class="mg-l-10">'+
			  +'</span>'
			  +'</label>'
              +'</div>'
        $(main).append(s)
...
function propsTitel(list,value,main){
        var  s = ""
           ...
           +'<label class="left-fn-title wd-150" id="desc_SubTitle">'+list+'</label>'
           +'<label class="wd-content-lable d-flex " id="field_SubTitle" >'
           +'<input type="text" class="textfield form-control" size="80" name="SubTitle" id="SubTitle" value="'+value+'">' 
           +'</label>'
           +'</div>'
       $(main).append(s)
...
//定时发布：
function  SetPublishDate(description,value,holder,main){
    var str = ''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_PublishDate">'
	    +'<label class="left-fn-title wd-150 ">'+description+'</label>'
	    +'<label class="">'
	    +'<input type="text" name="SetPublishDate" id="SetPublishDate" value="'+value+'"  placeholder="'+holder+'"   class="textfield date form-control hasDatepicker" size="92">'
        +'</label>'
	    +'</div>'
	    $(main).append(str)  
...
function IsPhotoNews(description,value,main){
    ...
    str+='<div class="row flex-row align-items-center mg-b-15" id="tr_IsPhotoNews" >'
       ...
       +'<input type="checkbox" value="1" name="IsPhotoNews" id="IsPhotoNews">'+'<span>'+'</span>'+'</label>'
       +'</label>'+'</div>'
        $(main).append(str)  
}
//图片
...
function Keyword(description,value,main,list){
    var str =''
        ...
        +'<input type="text" class="textfield form-control tagit-hidden-field" size="80" name="Keyword" id="Keyword" value="'+value+'">'
...
function content_type(description,value,main){
      var str =''
          str+='<div class="row flex-row align-items-center mg-b-15" id="tr_content_type">'
            +'<label class="left-fn-title wd-150" id="desc_content_type">'+description+'</label>'
            +'<label class="wd-content-lable d-flex " id="field_content_type">'
...
function anuor(description,value,main){
  var str =""
      str+='<div class="row flex-row align-items-center mg-b-15" id="tr_anuor">'
         +'<label class="left-fn-title wd-150" id="desc_anuor">'+description+'</label>'
         +'<label class="wd-content-lable d-flex " id="field_anuor">'
...
function videoid(description,value,main){
    var str=""
        ...
        +'<label class="left-fn-title wd-150" id="desc_videoid">'+description+'</label>'
        +'<label class="wd-content-lable d-flex " id="field_videoid">'
...
//视频类型:
      function  mediatype(description,value,main){
          var str =''
              ...
              +'<label class="left-fn-title wd-150" id="desc_mediatype">'+description+'</label>'
              +'<label class="wd-content-lable d-flex" id="field_mediatype">'
              +'<input type="text" class="textfield form-control" size="80" name="mediatype" id="mediatype" value="'+value+'">'
              +'</label>'+'</div>'
            $(main).append(str) 
      }
//节目单频道编号
function epgchannelid(description,value,main){
    var str =''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_epgchannelid">'
          +'<label class="left-fn-title wd-150" id="desc_epgchannelid">'+description+'</label>'
          +'<label class="wd-content-lable d-flex " id="field_epgchannelid">'
...
function href_app(description,value,main){
    var str = ''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_href_app">'
            +'<label class="left-fn-title wd-150" id="desc_href_app">'+description+'</label>'
            +'<label class="wd-content-lable d-flex " id="field_href_app">'
...
function Photo4(description,value,main){
    var str = ""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_Photo4">'
           +'<label class="left-fn-title wd-150" id="desc_Photo4">'+description+'</label>'
           +'<label class="wd-content-lable d-flex " id="field_Photo4">'
...
function Photo2(description,value,main){
    var str = ''
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_Photo2">'
          +'<label class="left-fn-title wd-150" id="desc_Photo2">'+description+'</label>'
          +'<label class="wd-content-lable d-flex " id="field_Photo2">'
          ...
          +'</label>'+'<label>'+'<input type="button" value="选择" onclick="" class="btn btn-primary tx-size-xs mg-l-10 Photo2_xz">'
          +'</label>'+'<label>'+'<input type="button" value="预览" onclick="" class="btn btn-primary tx-size-xs mg-l-10 Photo2_yl">'
          +'</label>'+'</div>'
           $(main).append(str)
         //选择:
...
function Photo3(description,value,main){
      var str = ''
          str+='<div class="row flex-row align-items-center mg-b-15" id="tr_Photo3">'
             +'<label class="left-fn-title wd-150" id="desc_Photo3">'+description+'</label>'+'<label class="wd-content-lable d-flex " id="field_Photo3">'
             ...
             +'</label>'+'<label>'+'<input type="button" value="选择" onclick="" class="btn btn-primary tx-size-xs mg-l-10  Photo3_xz">'
             +'</label>'+'<label>'+'<input type="button" value="预览" onclick="" class="btn btn-primary tx-size-xs mg-l-10  Photo3_yl">'
             +'</label>'+'</div>'
        $(main).append(str)
         //选择:
...
function videourl(description,value,main){
      var str = ''
          str+='<div class="row flex-row align-items-center mg-b-15" id="tr_videourl">'
             +'<label class="left-fn-title wd-150" id="desc_videourl">'+description+'</label>'
             +'<label class="wd-content-lable d-flex " id="field_videourl">'
...
function td_liveid(description,value,main){
    var str =""
        ...
        +'<label class="left-fn-title wd-150" id="desc_td_liveid">'+description+'</label>'
        +'<label class="wd-content-lable d-flex " id="field_td_liveid">'
...
function juxian_liveid(description,value,main){
     var str =''
         str+='<div class="row flex-row align-items-center mg-b-15" id="tr_juxian_liveid">'
            +'<label class="left-fn-title wd-150" id="desc_juxian_liveid">'+description+'</label>'
            +'<label class="wd-content-lable d-flex " id="field_juxian_liveid">'+'<input type="text" class="textfield form-control" size="10" name="juxian_liveid" id="juxian_liveid" value="'+value+'">'
            +'</label>'+'</div>'
           $(main).append(str)
...
function secondcategory(description,value,main){
     var str =''
         str+='<div class="row flex-row align-items-center mg-b-15" id="tr_secondcategory">'
            +'<label class="left-fn-title wd-150" id="desc_secondcategory">'+description+'</label>'
            +'<label class="wd-content-lable d-flex " id="field_secondcategory">'
...
function pv_virtual(description,value,main){
    var str =''
        ...
        +'<label class="left-fn-title wd-150" id="desc_pv_virtual">'+description+'</label>'
        +'<label class="wd-content-lable d-flex " id="field_pv_virtual">'
...
function pv(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_pv">'
           +'<label class="left-fn-title wd-150" id="desc_pv">'+description+'</label>'
           +'<label class="wd-content-lable d-flex" id="field_pv">'
...
function zanvirtualnum(description,value,main){
    var str = ''
           str+='<div class="row flex-row align-items-center mg-b-15" id="tr_zan_virtual_num">'
            +'<label class="left-fn-title wd-150" id="desc_zan_virtual_num">'+description+'</label>'
            +'<label class="wd-content-lable d-flex " id="field_zan_virtual_num">'
...
function baoliao_localtion(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_baoliao_localtion">'
            +'<label class="left-fn-title wd-150" id="desc_baoliao_localtion">'+description+'</label>'
            +'<label class="wd-content-lable d-flex " id="field_baoliao_localtion">'
...
function jd(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_jd">'
          +'<label class="left-fn-title wd-150" id="desc_jd">'+description+'</label>'
          +'<label class="wd-content-lable d-flex " id="field_jd">'
...
function wd(description,value,main){
    var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_wd">'
            +'<label class="left-fn-title wd-150" id="desc_wd">'+description+'</label>'
            +'<label class="wd-content-lable d-flex " id="field_wd">'
...
function baoliao_userid(description,value,main){
     var str=""
        str+='<div class="row flex-row align-items-center mg-b-15" id="tr_baoliao_userid">'
           +'<label class="left-fn-title wd-150" id="desc_baoliao_userid">'+description+'</label>'
           +'<label class="wd-content-lable d-flex " id="field_baoliao_userid">'
