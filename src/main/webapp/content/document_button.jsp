...
function getSecondcategoryList(channelid){
	var	dialog = new top.TideDialog();
		dialog.setWidth(500);
		dialog.setHeight(400);
		dialog.setUrl("../content/secondcategoryList.jsp?ChannelID="+channelid+"&fieldName=secondcategory");
		dialog.setTitle('选择');
		dialog.show();
}
function getListHref(channelid){
	var doc_type = $("input[name='doc_type']:checked").val();
	if(doc_type==0||doc_type==1||doc_type==2){
		var url = "../content/documentHref_index.jsp?ChannelID="+channelid+"&fieldName=href_app&doc_type="+doc_type;
		var	dialog = new top.TideDialog();
		...
		var	dialog = new top.TideDialog();
			dialog.setWidth(500);
			dialog.setHeight(400);
			dialog.setUrl("../content/listHref.jsp?ChannelID="+channelid+"&fieldName=href_app&TargetName=list_1_0.shtml");
			dialog.setTitle('选择');
			dialog.show();
	}
}
function getJuxianId(channelid){
	var doc_type = $("input[name='doc_type']:checked").val();
	var url = "../content/documentHref_index.jsp?ChannelID="+channelid+"&fieldName=juxian_liveid&doc_type="+doc_type;
	var	dialog = new top.TideDialog();
		dialog.setWidth(1000);
		dialog.setHeight(600);
		dialog.setUrl(url);
...
$.getScript("../common/controlfield_button.js");
</script>
</body>
</html>
