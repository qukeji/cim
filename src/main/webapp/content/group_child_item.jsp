...
function addDocument(r_itemid,r_channelid)
{
	if(FieldID>0)
	{
		opener.groupChildItemJS(r_itemid,r_channelid,0);
		top.close();
	}
	else
	{
...
<frameset id="mainFrm" cols="180,*"  frameborder="0" framespacing="0">
  <frame name="menu" src="group_child_left.jsp?FieldID=<%=FieldID%>&ChannelID=<%=ChannelID%>" scrolling="NO">
  <frame name="main" src="group_child_content.jsp">
