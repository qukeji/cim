  ...
  <tr> 
    <td height="36" align="center" class="font-14"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="left"><img id="icon" src="../images/icon_content_24.gif" border="0" align="absmiddle">频道结构</td>
          <td width="8"></td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td align="center" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="center" valign="top" class="box-white" id="leftFrm"><iframe frameborder=0 scrolling=auto src="group_child_channel_tree.jsp?FieldID=<%=FieldID%>&ChannelID=<%=ChannelID%>" style=height:100%;visibility:inherit;width:100%;></iframe></td>
