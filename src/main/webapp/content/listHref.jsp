...
String channel_Serial = getParameter(request,"channel_Serial");
...
if(!"".equals(channel_Serial)){
	channel = CmsCache.getChannel(channel_Serial);
	...
	if (channelid!=""&&(channelid.indexOf(",")<0))
	{
		...
		$.ajax({
			...
			success:function (res) {
				parent.$("#"+fieldName).prop("value",res.trim());
				top.TideDialogClose();
			}
        });
	}
