	...
	function recommendOut1(id)
{
    ...
    function addDocument_column()
{
	var url="../content/document_column.jsp?ItemID=0&ChannelID=" + ChannelID;
	window.open(url);
}	
</script>
</head>
...
%>
		...
		<div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
			...
			<div class="btn-group mg-l-auto hidden-sm-down">
				<a href="javascript:addDocument_column();" class="btn btn-outline-info">新建</a>
				<%if(canApprove){%>
			...
			<div class="dropdown mg-l-auto hidden-md-up">
				...
				<div class="dropdown-menu dropdown-menu-right pd-10">
					<nav class="nav nav-style-1 flex-column">
						<a href="javascript:addDocument_column();" class="nav-link">新建</a>
						<%if(canApprove){%>
