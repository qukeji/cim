...
<%!
	public JSONArray listChannel_content_JS(UserInfo user) throws SQLException,JSONException, MessageException
  {
      ...
      for (int i = 0; i < childs.size(); ++i) {
        ...
        if ((type == 5) && (user.hasChannelShowRight(channelid))) {
          ...
          if ((type == 5) || (ChannelNumber <= 100)){
			  ...
			  JSONArray oo = listChannel_content_JS(channelid, varName, user, ChannelNumber);
			  o.put("child", oo);
...
JSONArray o2 = listChannel_content_JS(userinfo_session);
out.println(o2);
%>
