...
<head>
    ...
    <title>TideCMS 7 <%=CmsCache.getCompany()%>
    </title>
    ...
    <style>
        ...
        .right-box{min-height: 100%;}
        .channel-container, .power-containner { border: 1px solid #e9ecef;min-height: 337px;}
        .channel-container ul li {justify-content: flex-start; align-items: center; background: #f2f2f2; border-bottom: 1px solid #ddd; cursor: pointer; } 
        .channel-container ul li.active {background: #17A2B8; color: #fff; }
        .power-containner .row {margin: 0 !important; }
        label.ckbox.mg-r-20{margin-right: 0;min-width: 24%;cursor: pointer;margin-right: 1%}
    </style>
    ...
    <script>
        ...
        function ok() {
            ...
            parent.$("#reporter").prop("value", userId);
            parent.$("#username").prop("value", Username);
            top.TideDialogClose();
...
<div class="bg-white modal-box">
    ...
    <div class="modal-body modal-body-btn pd-20 overflow-y-auto">
        <div class="d-flex ht-100p-force justify-content-between">
            ...
            <div class="right-box wd-100p">
                <div class="bot-power mg-b-20">
    ...
    <div class="btn-box">
        <div class="modal-footer">
            <button id="submitButton" name="submitButton" type="button" class="btn btn-primary tx-size-xs"
                    onclick="ok()">确认
            </button>
            <button id="btnCancel1" name="btnCancel1" type="button" onclick="top.TideDialogClose();"
...
<script>
    ...
    $(function () {
        ...
        $("#userList").on('click','input',function () {
    ...
    function showUser(id) {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "getReporter.jsp?GroupID=" + id + "&users=" + users,
