...
<%
boolean exist = false;
String Sql = "select * from counter_stat_month where Month='"+Year + "-" + Month+"'";
...
%>
        <table border=0 cellpadding=3 cellspacing=0 width="100%" bgcolor="#FFFFFF">
          <tbody> 
          <tr align="right"> 
            <td colspan=4 bgcolor="#000099"> <font color="#FFFFFF"><%=Month%> 
              月 访 问 统 计 分 析 （总量：<%=TotalNumber%>）</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              <a href="statallmonth.jsp"><font color="#FFFFFF">[全部月分析]</font></a></td>
          </tr>
          <tr bgcolor="#CCCCCC"> 
            <td align=left>日期</td>
