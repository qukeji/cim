...
<%
boolean exist = false;
String Sql = "select * from counter_stat_week where Week='"+Year + "-" + Week+"'";
...
%>
        <table border=0 cellpadding=3 cellspacing=0 width="100%" bgcolor="#FFFFFF">
          <tbody> 
          <tr align="right"> 
            <td colspan=4 bgcolor="#000099"> <font color="#FFFFFF">本 周 访 问 统 计 
              分 析 （总量：<%=TotalNumber%>）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="statallweek.jsp"><font color="#FFFFFF">[全部周分析]</font></a></font> 
            </td>
          </tr>
          <tr bgcolor="#CCCCCC"> 
            <td align=left>星期</td>
