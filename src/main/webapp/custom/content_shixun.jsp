...
{
	tidecms.dialog("content/video_player_byvideoid_gqg.jsp?id="+id+"&channelid="+ChannelID,640,520,"视频预览");
} 
</script>
</head>
<body>
...
<div class="viewpane_c1" id="SearchArea" style="display:<%=(S_OpenSearch==1?"":"none")%>">
  ...
  <tr>
    ...
    <input name="Submit" type="Submit" class="tidecms_btn2" value="查找" /><input type="hidden" name="OpenSearch" id="OpenSearch" value="1"></form></td>
    <td width="20">&nbsp;</td>
  </tr>
</table>
...
<div class="content_2012">
	<div class="toolbar">
    	<div class="toolbar_l">
            ...
            <ul class="toolbar2">				
                <%if(canApprove){%><li  class="first"><a href="javascript:approve();">发布</a></li><%}%>
...
%>
  <tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>"  status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item">
    ...
    <div class="v9_button" onclick="Preview22(<%=id_%>);"><img src="../images/v9_button_2.gif" title="预览" /></div>
...
<%
	...
	if(listType==3)
	{
		String Photo	= convertNull(Rs.getString("Photo"));
		if("".equals(Photo))
			Photo = "http://www.tidecms.com/images/fs_1.png";
		String photoAddr = "";
		if(Photo.startsWith("http://"))
			photoAddr = Photo;
		else
