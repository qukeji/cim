...
function next(){	
	...
	if (channelid!=""&&(channelid.indexOf(",")<0)){
		TideConfirm("提示","确实要<%=msg%>吗?","handArticle","")
	}
	else{
...
<body class="collapsed-menu email">
	...
	<script>
        $(function(){
			...
			var html = '<li class="treeview"><a href="#" load="0" channelId="0"><i class="fa fisrtNav fa-home" have="1"></i> <span><%=msg%></span></a><ul class="treeview-menu" style="display: block;">';
