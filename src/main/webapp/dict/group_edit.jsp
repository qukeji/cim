...
<table  border="0">
    ...
    <td valign="middle"><input type="text" name="Name" id="Name" class="textfield" value="<%=group.getName()%>"/></td>
  </tr>
    <tr>
    <td align="right" valign="middle">代码：</td>
    <td valign="middle"><input type="text" name="Code" id="Code" class="textfield" value="<%=group.getCode()%>"/></td>
  </tr>
</table>
</div>
</div>
