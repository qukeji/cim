	...
	<table cellpadding="0" cellspacing="0" width="100%" height="100%">
		<tr>
			<td width="100%">
				...
				<tbody >
				<tr><td><iframe  marginheight="0" frameborder="no"  id="photo" name="photo" marginwidth="0" scrolling="auto" height="420" width="750" src="../../photo/editor_photo_select_index.jsp"></iframe></td><td></td></tr>
				</tbody>
				</table>
			</td>
		</tr>
