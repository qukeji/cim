  ...
  <tr> 
    <td height="36" align="center" class="font-14"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="left">邮件列表<%if(Back==1){%>&nbsp;&nbsp;&nbsp;<a href="../application.jsp" target="_parent">>>返回</a><%}%></td>
          <td width="8"></td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td align="center" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="left" valign="top" class="box-white" id="leftFrm"><iframe frameborder=0 scrolling=no src="menu.jsp" style="height:100%;visibility:inherit;width:100%;"></iframe></td>
