	...
	<div class="br-sideleft overflow-y-auto">
        ...
        <a href="Index2018.jsp" class="br-menu-link menu-explorer">
            <div class="br-menu-item">
               <i class="menu-item-icon fa fa-film tx-18-force"></i>
                <span class="menu-item-label">期刊</span>
            </div>
        </a>
		...
		<div class="br-mainpanel with-first-nav">
			...
			<div class="d-flex pd-30">
				...
				<div class="">
                    <h4 class="tx-gray-800 mg-b-5">电子报管理系统</h4>
					<p class="mg-b-0">本系统对报纸版面进行电子化排版，组织内容，实现在线看报纸功能</p>	
					</div>
								...
								<div class="d-flex align-items-center justify-content-between">
									<div>
										<p class="tx-13 tx-uppercase tx-inverse tx-spacing-1 tx-18">
											<i class="fa fa-line-chart theme-tx-color mg-r-5"></i>电子报数据排行
										</p>										
									</div>									
								</div>
							</div>
            ...
            success: function(data){
			    ...
			    num=data.num1;
                 ...
                 for(var i=0; i<xaxis.length;i++){
                    ...
                    dataArray.push({y:xaxis[i], a: num[i]});
                     }
...
<script type="text/javascript">
    $(function()
    {
        var url="epaper_data_statistics.jsp";
        $.ajax({
            type:"GET",
            url: url,
            dataType:"json",
