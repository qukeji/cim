...
String custom = getParameter(request,"custom");//是否定制
...
if(pageName=="") pageName = "content_epg.jsp";
...
function importEpg()
{
	tidecms.dialog("epg/upload_epg.jsp?ChannelID="+<%=ChannelID%>,600,400,"导入节目单",2);
}

function downloadEpg()
{
	window.open("new_epg_template.csv");
}
</script>
</head>
<body>
<div class="content_t1">
    ...
    <div class="content_new_post">
		...
		<%}%>
		<div class="top_button button_inline_block" onClick="importEpg();">
				<div class="top_button_outer button_inline_block">
					<div class="top_button_inner button_inline_block">
						<span class="img"><img src="../images/icon/upload.png" /></span>
						<span class="txt">导入节目单</span>
					</div>
				</div>
		</div>

		<div class="top_button button_inline_block" onClick="downloadEpg();">
				<div class="top_button_outer button_inline_block">
					<div class="top_button_inner button_inline_block">
						<span class="img"><img src="../images/icon/43.png" /></span>
						<span class="txt">节目单模板</span>
					</div>
				</div>
		</div>
...
String ListSql = "select id,Title,User,Photo,Weight,GlobalID,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews,FROM_UNIXTIME(PublishDate) as PublishDate,Summary,start_time,end_time";
...
<thead>
		<tr id="oTable_th">
    				...
    				<th class="v3" style="padding-left:10px;text-align:left;">节目单</th>
					<th class="v8"  align="center" valign="middle">开始时间</th>
					<th class="v8"  align="center" valign="middle">结束时间</th>
    				...
    				<%if(IsClick==1){%>
    				<%}%>
					<th class="v4" align="center"  align="left" valign="middle" style="padding-left:10px;">状态</th>
					<th class="v4" align="center"  align="left" valign="middle" style="padding-left:10px;">作者</th>
...
while(Rs.next())
{
	...
	PublishDate=Util.FormatDate("MM-dd",PublishDate);
	 
	String StartTime	= "";
	try{StartTime = Rs.getString("start_time");}catch (Exception e){e.printStackTrace();};
	String endTime	= "";
	try{endTime = Rs.getString("end_time");}catch (Exception e){e.printStackTrace();};
...
%>
  <tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>"  status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item">
	...
	<td class="v8" align="center" > <%=StartTime%></td>
	<td class="v8" align="center" > <%=endTime%></td>
	 
	<td class="v1" align="center" valign="middle"><%=StatusDesc%></td>
	<td class="v4" align="center" style="color:#666666;"><%=UserName%></td>
