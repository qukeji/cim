...
function importEpg() 
{
		...
		dialog.setUrl("../epg/upload_epg2018.jsp?ChannelID=<%=ChannelID%>");
		dialog.setTitle("导入节目单");
...
{
	window.open("../epg/new_epg_template.csv");
}
</script>
</head>
...
{
	ListSql += " order by start_time desc";
}
...
%>
		...
		<div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
			...
			<div class="btn-group mg-l-auto hidden-sm-down">
				...
				<%}%>
					<a href="javascript:importEpg();" class="btn btn-outline-info">导入节目单</a>
					<a href="javascript:downloadEpg();" class="btn btn-outline-info">节目单模板</a>
			</div>
			<!-- START: 按钮过多时的部分功能下拉 -->
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-medium">节目单</th>
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down">开始时间</th>
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down">结束时间</th>
							<%if(IsWeight==1){%>
