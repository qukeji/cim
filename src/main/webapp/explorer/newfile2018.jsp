...
{ 
	...
	String  Path			= SiteFolder + "/" + FolderName + (!FolderName.equals("")?"/":"") + Name;
	String RealPath = Path;
	File file = new File(RealPath);
	file.createNewFile();
	new Log().FileLog(LogAction.file_add,"/" + FolderName + "/" + Name,userinfo_session.getId(),SiteId);
...
<body  onload="init();">
	...
	<form name="form" action="newfile2018.jsp" method="post" onSubmit="return check();">
