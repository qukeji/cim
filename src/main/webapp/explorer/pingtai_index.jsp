<%@ page import="tidemedia.cms.system.*,tidemedia.cms.util.*,java.util.Date,java.sql.*,
				tidemedia.cms.base.*,
				tidemedia.cms.user.*"%>
...
<link rel="stylesheet" href="../style/2018/sidebar-menu-file.css">
...
<body class="collapsed-menu email" id="withSecondNav" onLoad="init();">
	...
	<script>
        ...
        $(function(){
			'use strict';
            $("#system-menu-exploer").addClass("active");
			$("#system-menu-cms-exploer").addClass("active");
			...
			$(document).on('mouseover', function(e){
			  ...
			  if($('body').hasClass('collapsed-menu')) {
				...
				if(targ) {
				  ...
				  $("#system-menu-exploer").css("display","block");
				  ...
				  $("#system-menu-exploer").css("display","none");
				}
			  }
			});
			...
			if(load==1){				
			 ...
			 if(window.frames["content_frame"]){
				 if(folderName && folderName!="\\")
				    changeFrameSrc(window.frames["content_frame"] , "file_list2018.jsp?FolderName=" + encodeURI(folderName)+"&SiteId="+siteId)
				 else
				    changeFrameSrc(window.frames["content_frame"] , "file_list2018.jsp?FolderName=&SiteId="+siteId)
			 }
		  });
		}
