...
<style>
	body{background:none;padding:0;overflow-y: hidden}
	.content_2012{margin: 10px !important;}
	...
	#divUploadPhoto{height:394px;overflow-y:auto;}
</style>
...
<script language=javascript>
	...
	//var dialog	= window.parent.parent;//window.parent ;
...
//	dialog.AddTab( 'SelectPhoto', "从图片库选择") ;
	...
	var oImage =ueditor.selection.getRange().getClosedNode();//dialog.Selection.GetSelectedElement() ;//是否选中图片
		...
		if(document.getElementById("divSelectPhoto").style.display!="none"){
			...
			$.ajax({
				...
				success:function(msg){
					...
					if(msg!=""){
						window.parent.parent.parent.h5_insertContent(msg,true); 
...
<div id="divInfo">
    <div class="content_2012">
		...
		<div class="line" style="overflow:hidden;">
			...
			<div class="fck_f_l w170 lh28">
				<span fcklang="DlgImgAlign" class="fck_f_l_box" style="width:48px;">加水印：</span>
...
<script>	
	...
	jQuery(function() {
		...
		uploader.on( 'uploadFinished', function() {
			...
			{
			   //alert(returnData)
				//window.parent.parent.setInsertContent(returnData,true); 
				window.parent.parent.parent.h5_insertContent(returnData,true); 				
