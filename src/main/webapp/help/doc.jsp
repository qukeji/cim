...
<table width="100%" border="0" class="view_table">
	<tr>
        ...
        <tr> 
                <td style="padding-bottom: 10px;padding-top: 10px;"><a href="javascript:downLoadFile('/cms/TideCMS编辑操作手册v1.01.20151105.doc')" target="_blank">TideCMS编辑操作手册v1.01.20151105.doc</a></td>
        </tr>
        <tr> 
                <td style="padding-bottom: 10px;padding-top: 10px;"><a href="javascript:downLoadFile('/cms/TideCMS系统管理员手册v1.06.20140207.doc')">TideCMS系统管理员手册v1.06.20140207.doc</a></td>
        </tr>
        <tr> 
                <td style="padding-bottom: 10px;padding-top: 10px;"><a href="javascript:downLoadFile('/cms/TideCMS模板编写参考指南v2.06.20151029.docx')">TideCMS模板编写参考指南v2.06.20151029.docx</a></td>
        </tr>
        <tr> 
                <td style="padding-bottom: 10px;padding-top: 10px;"><a href="javascript:downLoadFile('/cms/TideCMS接口文档.docx')">TideCMS接口文档.docx</a></td>
        </tr>
        <tr> 
                <td style="padding-bottom: 10px;padding-top: 10px;"><a href="javascript:downLoadFile('/cms/TideCMS二次开发参考指南v1.00.20140704.doc')">TideCMS二次开发参考指南v1.00.20140704.doc</a></td>
        </tr>
