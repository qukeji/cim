...
String dir="project";
	int channelid = CmsCache.getChannel("jixiao_scheme").getId();
...
<body class="email"  onLoad="init();">
    ...
    <div class="br-mainpanel br-mainpanel-file " id="js-source">
        <iframe src="project_content.jsp?id=<%=channelid%>" id="content_frame" style="width: 100%;height: 100%;" frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
