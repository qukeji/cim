...
<%
    ...
    /*ListSql += whereSql + " group by pd";
    CountSql += whereSql + " group by pd) a";*/
    ...
    <div class="br-pagebody pd-x-20 pd-sm-x-30">
        <div class="card bd-0 shadow-base">
            <table class="table mg-b-0" id="content-table">
                <thead>
                <tr>
                    <th class="wd-200 ">姓名</th>
                    <th class="tx-12-force tx-mont tx-medium wd-200 ">上传量</th>
                    <th class="tx-12-force tx-mont tx-medium wd-450 ">统计日期</th>
