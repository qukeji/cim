...
String channel_tree_string_14273 = tree.listChannel_content_JS(14273,"tree",userinfo_session,tree.getChannelNumber());
...
if (document.getElementById) {
	var tree = new WebFXTree('位置管理','javascript:show(14273)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	<%=channel_tree_string_14273%>
	document.write(tree);
