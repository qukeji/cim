...
String channel_tree_string_14272 = tree.listChannel_content_JS(14272,"tree",userinfo_session,tree.getChannelNumber());
...
if (document.getElementById) {
	var tree = new WebFXTree('生产管理','javascript:show(14272)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	<%=channel_tree_string_14272%>
	document.write(tree);
