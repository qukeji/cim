...
String channel_tree_string_16150 = tree.listChannel_content_JS(channelId,"tree",userinfo_session,tree.getChannelNumber());
...
if (document.getElementById) {
	var tree = new WebFXTree('线索管理','javascript:show(<%=channelId%>)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	<%=channel_tree_string_16150%>
	document.write(tree);
