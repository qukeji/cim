...
String channel_tree_string_16141 = tree.listChannel_content_JS(channelId,"tree",userinfo_session,tree.getChannelNumber());
...
if (document.getElementById) {
	var tree = new WebFXTree('热度排行','javascript:show(<%=channelId%>)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	<%=channel_tree_string_16141%>
	document.write(tree);
