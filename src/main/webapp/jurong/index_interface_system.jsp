...
<body onLoad="init()">
<%
int channelId = CmsCache.getParameter("daping").getJson().getInt("xiansuo");
%>
<div class="column_nav" id="leftTd"><iframe frameborder="0" src="channel_tree_interface_system.jsp" style="width:100%;height:100%;" name="ifm_left" id="ifm_left"></iframe></div>
...
<div class="column_viewer" id="rightTd"><iframe frameborder="0" src="../content/content.jsp?id=<%=channelId%>" style="width:100%;height:100%;" name="ifm_right" id="ifm_right"></iframe></div>
