...
<body onLoad="init()">
<%
int channelId = CmsCache.getParameter("daping").getJson().getInt("hot");
%>
<div class="column_nav" id="leftTd"><iframe frameborder="0" src="channel_tree_interface_xuanti.jsp" style="width:100%;height:100%;" name="ifm_left" id="ifm_left"></iframe></div>
