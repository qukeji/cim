...
<head>
<meta charset="utf-8">
<title>热度排行 - Tide Media Center 融合媒体业务平台</title>
...
<div class="br-logo"><a href="<%=base%>/tcenter/main.jsp"><img src="../images/2018/system-logo.png"></a></a></div>
    <%
    int channelId1 = CmsCache.getParameter("daping").getJson().getInt("shengchan");
			...
			<a href="javascript:show(id=<%=channelId1%>);" class="br-menu-link active menu-home">
					<div class="br-menu-item">
						<i class="menu-item-icon fa fa-home tx-22"></i>
							<span class="menu-item-label">生产管理</span>
					</div>
					<!-- menu-item -->
			</a>
...
<div class="br-header" style="margin-bottom: 200px">
    <div class="br-header-left">
        ...
        <div class="hidden-md-down system-name"><a href="javascript:;"><i class=""></i>生产管理</a></div>
    </div>
...
<div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
    <iframe name="ifm_right" id="content_frame" src="../content/content2018.jsp?id=<%=channelId1%>" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
</div><!-- br-mainpanel -->
...
<script type="text/javascript">
 ...
 function show(id){
     ...
     var loc = "";
     loc = "../content/content2018.jsp?id="+id;
