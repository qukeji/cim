...
//添加判断有内容类型的频道
String ListSql = "select id,Title,doc_type,item_type,Photo,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews";
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<%}%>
							<th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-200">操作</th>
						</tr>
					</thead>
                  <%}%>
					<tbody>
