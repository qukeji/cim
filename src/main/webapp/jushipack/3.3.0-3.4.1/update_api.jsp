...
//创建字段
public void createField(String FieldName,String FieldDesc,String FieldType,String Default,int ChannelID,String Options,int DataType,int isHide,String Caption) throws MessageException, SQLException{
	try{
		ArrayList <FieldGroup> fieldGroupArray = CmsCache.getChannel(ChannelID).getFieldGroupInfo();
...
//更新字段（默认值）
public void updateField(String fieldName,int channelId,String DefaultValue) throws MessageException, SQLException{
