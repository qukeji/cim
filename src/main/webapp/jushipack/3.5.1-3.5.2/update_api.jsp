...
//频道引入模板
public void useTemplate(int channelId , int templateId, String Label,String TargetName,int TemplateType,int FileNameType,String FileNameField,String whereSql) throws MessageException, SQLException{
	String message1 ="";
	try{
		//判断模板是否引入
