...
channel_tree_string = tree.listChannel_content_JS(14252,"tree",userinfo_session,100);
//out.println(channel_tree_string);
%>
...
var channel_tree_id_path = getCookie("sns_channel_path");
var node = null;
...
<div class="menu_top_2012">
	<div class="m_t_main">
		<div class="m_t_title"><img src="../images/sns.png" />直播管理</div>
	</div>
</div>
...
function show(id)
{
	...
	if (tree.getSelected())
	{
		...
		document.cookie = "sns_channel_path=" + channel_tree_id_path + ";path=/;expires=" + expires.toGMTString();
	}
	}catch(e){}
...
if (document.getElementById) {
	var tree = new WebFXTree('直播','javascript:show(-1)\" ChannelID=\"0');
...
var lsh_14272 = new WebFXTreeItem('中央台','javascript:show(14272);\" ChannelID=14272 ChannelType=\"0','','../images/tree/16_channel_icon.png','../images/tree/16_openchannel_icon.png');
lsh_14271.add(lsh_14272);
var lsh_14273 = new WebFXTreeItem('中央台','javascript:show(14273);\" ChannelID=14273 ChannelType=\"0','','../images/tree/16_channel_icon.png','../images/tree/16_openchannel_icon.png');
lsh_14271.add(lsh_14273);
	document.write(tree);
