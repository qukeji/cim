...
<head>
<meta charset="utf-8">
<title>云资源采集_tidemedia center</title>
...
<div class="frame">
	<div class="frame_tool">
    	<div class="frame_tool_l">
        	<div class="frame_logo"><a href="main.jsp">tidemedia center</a></div><span class="frame_tool_arr">></span><div class="frame_product_name">云资源采集</div>
        </div>
...
<div class="header_menu" id="spider">
	<ul>
        ...
        <li id="home_platform" href="spider/cloud_index.jsp?id=17589"><a href="javascript:menu('platform');">云资源平台数据</a></li>
        <li id="home_manage" href="other/index.jsp?id=13097"><a href="javascript:menu('manage');">本地采集数据</a></li>
        <li id="home_set" href="other/index.jsp?id=17547"><a href="javascript:menu('set');">采集管理</a></li>
        <li id="home_sys" href="other/index.jsp?id=17548"><a href="javascript:menu('sys');">采集监测</a></li>
		<!--
        <li id="home_peizhi" href="other/index.jsp?id=17549"><a href="javascript:menu('peizhi');">系统配置</a></li>-->
    </ul>
</div>
<div class="frame_main" name="frame_main" id="frame_main"  frameborder="no"  border="0"><!--  name="frame_main" id="frame_main" frame_main层的高度需要js算出来，高度=浏览器高度-73px，iframe的高度也一样 -->
	<!-- iframe内容 -->
	<iframe id="main" name="main" frameborder="0" scrolling="no" border="0" style="width:100%;" src="blank_resource.jsp"></iframe>
