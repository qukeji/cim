...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" id="" scroll="no" class=""  onLoad="init();">
    ...
    <div class="br-mainpanel with-first-nav">
        <iframe src="<%=request.getContextPath()%>/company/request/list" id="content_frame" style="width: 100%;height: 100%;" frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
	...
	<script>
		...
		$(function() {
			...
			$("#system-menu-cms-request").addClass("active");
