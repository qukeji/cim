...
<%
    ...
    if (Submit.equals("Submit")) {
        ...
        out.println("<script>var dialog = new top.TideDialog();dialog.showAlert(\"个人信息修改成功！\");</script>");
    }
...
<head>
    ...
    <script language="javascript">
        ...
        function check() {
            ...
            if (pwd == "") {
                dialog.showAlert("密码不能为空", "danger");
                $("#RePassword").val("");
                return false;
            }
            if (repwd == "") {
                dialog.showAlert("请再次输入密码", "danger");
                $("#Password").val("");
                return false;
            }
            if (pwd != repwd) {
                dialog.showAlert("两次输入不一致", "danger");
                $("#Password").val("");
                $("#RePassword").val("");
                return false;
            }
            ...
            if (uname == pwd) {
                dialog.showAlert("用户名密码不能相同", "danger");
                $("#Password").val("");
                $("#RePassword").val("");
                return false;
            } else {
                if (role == "系统管理员" && pwd.length < 8) {
                    dialog.showAlert("系统管理员的密码长度不能小于8位", "danger");
                    return false;
                } else if ((role == "频道管理员" || role == "编辑") && pwd.length < 6) {
                    dialog.showAlert("频道管理员或编辑的密码长度不能少于6位", "danger");
                    return false;
                } else {
                    return true;
                }
        ...
        function getCode() {
            var phone = $("#phone").val();
            if (phone == "") {
                dialog.showAlert("请输入手机号", "danger");
            } else {
                $.ajax({
                    type: "get",
                    ...
                    success: function (data) {
                        if (data.state == 1) {
                            dialog.showAlert("验证码发送成功", "danger");
                        } else {
                            dialog.showAlert("验证码发送失败", "danger");
                        }
                    }
                });
            }
...
<div class="br-mainpanel br-mainpanel-file" id="js-source">
    ...
    <div class="br-pageheader pd-y-15 pd-md-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            <span class="breadcrumb-item active"><a class="breadcrumb-item"
                                                    href="javascript:;">你的姓名:</a><%=userinfo.getName()%></span>
        </nav>
    </div><!-- br-pageheader -->
            ...
            <div class="card bd-0 shadow-base">
                <table class="table mg-b-0" id="content-table">
                    ...
                    <tr>
                        ...
                        <th class="tx-12-force tx-mont tx-medium hidden-xs-down"
                    ...
                    <tr>
                        ...
                        <td><input class="form-control wd-230" placeholder="" type="text" name="Name"
                                   value="<%=userinfo.getName()%>"></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle !important; text-align:right;">电子邮件：</td>
                        <td><input class="form-control wd-230" placeholder="" type="text" name="Email"
                                   value="<%=userinfo.getEmail()%>"></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle !important; text-align:right;">电话：</td>
                        <td class="d-flex"><input class="form-control wd-230" placeholder="" type="text" name="Tel"
                                                  value="<%=userinfo.getTel()%>" id="phone"></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle !important; text-align:right;">验证码：</td>
                        <td class="d-flex"><input class="form-control wd-230" placeholder="" type="text" name="Code"
                                                  value="" id="code">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control wd-230" placeholder="" type="text" name="Comment"
                                   value="<%=userinfo.getComment()%>"></td>
                    </tr>
                    <!-- 修改密码-->
                    <tr>
                        <td style="vertical-align: middle !important; text-align:right;">新密码：</td>
                        <td><input class="form-control wd-230" placeholder="" type="password" name="Password"
                                   id="Password" value="">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control wd-230" placeholder="" type="password" name="RePassword"
                                   id="RePassword" value=""></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle !important; text-align:right;">角色：</td>
                        <td><%=userinfo.getRoleName()%>
                        </td>
                    </tr>
                    <tr>
                        <td class="hidden-xs-down" style="vertical-align: middle !important; text-align:right;">
                            <button name="startButton" type="submit" class="btn btn-primary tx-size-xs">确定</button>
                        </td>
                        <td class="hidden-xs-down"><a href="javascript:;" onclick="back();" name="Submit2"
                                                      class="btn btn-secondary tx-size-xs" data-dismiss="modal"
                                                      id="btnCancel1">取消</a></td>
