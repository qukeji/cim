...
Channel pgc_channel = ChannelUtil.getApplicationChannel("pgc");
int ChannelId = pgc_channel.getId() ;
//获取pgc_视频编号
...
if(company>0 && video_channel.isShareChannel())
{
	Channel channel_ = ChannelUtil.getCompanyChannelByShare(video_channel, company);
	if(channel_!=null) {
		childChannel = channel_.getId();
	}
}
	int parent = video_channel.getParent();
...
<div class="br-logo">
	...
	<%@include file="pgc_tree.jsp"%><!--静态包含-->
    <!-- ########## START: MAIN PANEL ########## -->
