...
int childChannel = doc_channel.getId() ;
int company = userinfo_session.getCompany();
if(company>0 && doc_channel.isShareChannel())
{
	Channel channel_ = ChannelUtil.getCompanyChannelByShare(doc_channel, company);
	if(channel_!=null) {
		childChannel = channel_.getId();
	}
}
int parent = doc_channel.getParent();
