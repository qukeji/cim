...
int childChannel = live_channel.getId() ;
int company = userinfo_session.getCompany();
if(company>0 && live_channel.isShareChannel())
{
	Channel channel_ = ChannelUtil.getCompanyChannelByShare(live_channel, company);
	if(channel_!=null) {
		childChannel = channel_.getId();
	}
}
int parent = live_channel.getParent();
%>
<!DOCTYPE html>
<html id="pgcMnanage">
<head>
