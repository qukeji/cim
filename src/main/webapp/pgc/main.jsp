	...
	<div class="br-sideleft overflow-y-auto">
		<label class="sidebar-label pd-x-15 mg-t-20 pd-sm-x-10"></label>
			<div class="br-sideleft-menu">
				...
				<a href="doc_index.jsp" class="br-menu-link menu-channel">
					<div class="br-menu-item">
						<i class="menu-item-icon fa fa-picture-o tx-20"></i>
						<span class="menu-item-label">图文</span>
					</div>
				</a>
				<a href="live_index.jsp" class="br-menu-link menu-channel">
					<div class="br-menu-item">
						<i class="menu-item-icon fa fa-play-circle-o tx-22-force"></i>
						<span class="menu-item-label">直播</span>
					</div>
				</a>
					</div>
			<!-- br-sideleft-menu -->
		...
		<div class="br-mainpanel with-first-nav">
			...
			<div class="td-logo theme-bg mg-r-10"><i class="tx-white fa fa-address-card tx-34"></i></div>
			<div class="">
				<h4 class="tx-gray-800 mg-b-5">PGC内容管理系统</h4>
				...
				<div class="row row-sm">
					<div class="col-sm-6 col-xl-3">
						<div class="theme-bg rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								...
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">内容总量</p>
									<p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1 num4">
					...
					<div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
						<div class="theme-bg-1 rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								<i class="fa fa-comment-o tx-60 lh-0 tx-white "></i>
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">直播活动总量</p>
									<p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1 zhibo">
					...
					<div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
						<div class="theme-bg-2 rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								<i class="fa fa-camera tx-60 lh-0 tx-white "></i>
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">图文数量</p>
									<p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1 tupian"></p>
					...
					<div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
						<div class="theme-bg-3 rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								...
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">视频数量</p>
									<p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1 shiping" id="main_pv1">0</p>
							...
							<div class="d-flex align-items-center justify-content-between">
								<div>
									<p class="tx-13 tx-uppercase tx-inverse tx-spacing-1 tx-18">
										<i class="fa fa-user-circle-o theme-tx-color mg-r-5"></i>PGC创作内容用户排行
									</p>									
								</div>									
							</div>
						</div>
		            ...
		            <div class="card shadow-base bd-0 pd-b-20 ">			              
		              <div class="bg-white pd-x-30 pd-y-20 rounded-bottom d-flex align-items-center justify-content-between">
		                <div class="d-flex align-items-center">
		                  ...
		                  <span class="mg-l-8 tx-black tx-18">数据类型统计</span>
		                </div><!-- d-flex -->		            
		              </div><!-- d-flex -->
...
<script type="text/javascript">
    $(function()
    {
        var url="pgc_data_statistics.jsp";
        $.ajax({
            type:"GET",
            url: url,
            dataType:"json",
            success: function(res){
                ...
                $('.tupian').html(res.tupian);
                $('.zhibo').html(res.zhibo);
                $('.shiping').html(res.shiping);
                $('.num4').html(res.count4);
                
                  
            var piedata = [
			  { label: "直播", data: [[1,res.zhibo]], color: '#85C441'},
			  { label: "图文", data: [[1,res.tupian]], color: '#F89D44'},
			  { label: "视频", data: [[1,res.shiping]], color: '#36B3E3'},
                ...
                for(var i in res){
                    html+='<tr>';
                     html+='<td class="pd-l-0-force wd-5p">'+
                          '<img src="../img/2018/tidemedia_logo.svg" class="wd-40 rounded-circle" alt="">'+
                          '</td>';
                    html+=  '<td>'+
                            '<h6 class="tx-inverse tx-14 mg-b-0"> '+res[i].juxian_username+
                            '</h6>'+
                            ' <span class="tx-12"> '+res[i].juxian_phone+
                            '</span>'+
                            '</td>';
                    html+=  '<td>'+
