...
{	 
	...
	out.println("<script>top.TideDialogClose({refresh:'right',frameid:'"+iframe+"'});</script>");return;
}
...
<body onload="init();" scroll="no">
	<div class="bg-white modal-box" >
		<form name="form" action="document_sort.jsp" method="post" onSubmit="return check();">
