...
String left="./editor_photo_left.jsp?type="+type;
String right="./editor_photo_right.jsp?type="+type;

Tree tree		= new Tree();
JSONArray arr = tree.listChannel_content_json(13451, "tree", userinfo_session,20);
%>
<!DOCTYPE html>
<html>
<head>
...
<body class="collapsed-menu email" onLoad="">
	...
	<script>
		...
		//============  模板管理=============================================================================
			...
			var html = '<li class="treeview"><a href="#" load="0" channelId="4347"><i class="fa fisrtNav fa-home" have="1"></i> <span>图片集</span></a><ul class="treeview-menu" style="display: block;">';
