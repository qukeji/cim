...
<script src="../common/2018/TideDialog2018.js"></script>
 <style>
 	...
 	#cutimg-box{ width: 100%; height: 100%; display: flex; flex-direction: column; }
 	#cutimg-box-header{ height: 40px; flex: 0 0 40px; background: #e8ecef; }
 	.pic_editor_area{ flex: 0 0 458px; height: 458px; }
 	.img-container{ width: 100%; height: 100%; }
 	.sr-only{display:none;}
 	input.form-control{ padding: 0.45rem; }
 	.cutimg-box label{ margin-bottom: 0; }
 	.btn-group-item{ color: #868ba1; border: 1px solid #0866c6; padding:5px 10px; display: inline-block; border-radius: 5px; margin-right: 5px; }
 	.btn-group-item.ac{ color: #fff; background: #0866c6; }
 	.btn-group-item:hover{ color: #868ba1; }
 	.btn-group-item.ac:hover{ color: #fff; }
 	.select2-container--default .select2-selection--single{ height: 33px; }
 	.select2-container--default .select2-selection--single .select2-selection__rendered{ height: 33px; padding: 0 0px 0 6px; }
 	.select2-container--default .select2-selection--single .select2-selection__arrow{ height: 33px; line-height: 33px; }
 	.wd-180{ width: 180px; }
 </style> 
</head>
<body>
	<div class="bg-white modal-box" >
	    <div class="modal-body modal-body-btn pd-0 ">
			<div class="config-box ht-100p">
				<div id="cutimg-box">
			        <div class="d-flex justify-content-center align-items-center" id="cutimg-box-header">
						...
						<a href="javascript:;" class="btn btn-primary btn-sm mg-r-5" onclick="Previeww();">预览</a>
			        </div>
