...
{
	var url='photo/photo_scheme_add.jsp';
...
function Details(id)
{
	...
	dialog.setWidth(350);
	dialog.setHeight(250);
	dialog.setUrl("photo/photo_scheme_edit.jsp?id=" + id);
...
<div class="content_t1">
	<div class="content_t1_nav"> 图片尺寸：</div>
...
%>
	...
	<td class="v1"><a href="javascript:Details(<%=id%>);"><%=Name%></a></td>
    <td class="v4" ><%=Width%></td>
    <td class="v1"  ><%=Height%></td>
	<td class="v4"  style="color:#666666;"><a href="photo_scheme.jsp?Action=Del&id=<%=id%>" class="operate" onclick=" if(confirm('你确认要删除吗?')) return true; else return false;">删除</a></td>
  </tr>
<%
			}		
}
...
%>
        ...
        <div class="viewpane_pages">
            ...
            <div class="center"><a href="photo_scheme.jsp?currPage=1&rowsPerPage=<%=rowsPerPage%><%=querystring%>" title="首页"><img src="../images/viewpane_pages1.png" alt="首页" /></a><%if(currPage>1){%><a href="parameter.jsp?currPage=<%=currPage-1%>&rowsPerPage=<%=rowsPerPage%><%=querystring%>" title="上一页"><img src="../images/viewpane_pages2.png" alt="上一页" />上一页</a><%}%><%if(currPage<TotalPageNumber){%><a href="parameter.jsp?currPage=<%=currPage+1%>&rowsPerPage=<%=rowsPerPage%><%=querystring%>" title="下一页">下一页<img src="../images/viewpane_pages3.png" alt="下一页" /></a><%}%><a href="parameter.jsp?currPage=<%=TotalPageNumber%>&rowsPerPage=<%=rowsPerPage%><%=querystring%>" title="末页"><img src="../images/viewpane_pages4.png" alt="末页" /></a></div>
		 <%}%>
            <div class="right">
