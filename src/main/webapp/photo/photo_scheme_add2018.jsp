...
<script type="text/javascript">
 ...
 <form  name="form" action="photo_scheme_add2018.jsp" method="POST" >     
	        ...
	        <div class="config-box">	
               <ul>
                 ...
                 <div class="row">                   		  	  	
		              ...
		              <label class="wd-230">
		                <input name="Width" size="32" class="form-control" placeholder="" type="text" >
		              </label>									            
	   		  	</div>
                <div class="row">                   		  	  	
		  	  		  <label class="left-fn-title">高：</label>
		              <label class="wd-230">
		                <input name="Height" size="32" class="form-control" placeholder="" type="text" >
		              </label>									            
	   		  	</div>				
