...
String ListSql = "select id,Title,Photo,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,Parent,Filesize";
...
<div class="content_t1">
    ...
    <div class="content_new_post">
		...
		<div class="top_button button_inline_block" onClick="uploadImages();">
				<div class="top_button_outer button_inline_block">
					<div class="top_button_inner button_inline_block">
						<span class="img"><img src="../images/icon/add.png" /></span>
						<span class="txt">批量上传</span>
					</div>
				</div>
		</div>
    </div>
...
<thead>
		<tr id="oTable_th">
					...
					<%}%>
					<th class="v1"	align="center" valign="middle">文档标题</th>
					<th class="v1"	align="center" valign="middle">频道</th>
					<th class="v1"	align="center" valign="middle">文件大小</th>
...
%>
  <tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>"  status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item">
	...
	<td  align="center" valign="middle"><span class="v3 pdoc" style="cursor:pointer;" ItemID="<%=p_itemid%>" ChannelID="<%=p_channelid%>"><%=p_title%></span></td>
	<td class="v1" align="center" valign="middle"><%=p_channelname%></td>
	<td class="v1" align="center" valign="middle"><%=FileSize_KB%>k</td>
...
$(".pdoc").click(function(){
	var vale=$(this).html();
	var itemid_=$(this).attr("ItemID");
	var channelid_=$(this).attr("ChannelID");
	window.open("../content/document.jsp?ItemID="+itemid_+"&ChannelID="+channelid_);
});
</script>
