...
<%}else if(field.getFieldType().equals("label")){%>
	...
	<tr><td><div class="line"><%=field.getDescription()%>：</div></td><td><div class="line"><%=field.getDisplayHtml(item!=null?item.getValue(field.getName()):"")%><input name="kewwordselect" type="button" class="submit" value="按关键词选择" onclick="selectByKeyword2()"></div></td></tr>
	...
	<%}else{
		out.println(field.getDisplayHtml2012(item));
	}%>
	<%}%>
<%}}%></table>
