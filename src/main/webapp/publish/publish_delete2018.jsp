...
String ids=Util.getParameter(request,"ItemID");

String	Submit	= getParameter(request,"Submit");
if(!Submit.equals("")){
	    String Sql = "delete from publish_item where id in(" + ids + ")";
...
<script type="text/javascript">
 ...
 <form name="form" method="post" action="publish_delete2018.jsp" >     
	    <div class="modal-body modal-body-btn pd-20 overflow-y-auto">
	        <div class="config-box mg-t-15">
	   		  	<div class="row">                   		  	  	
		  	  		  <label class="left-fn-title">你确定要删除选中的待发布任务?</label>							            
	   		  	</div>	
                 <div class="row">                              				
