  ...
  <tr>
    <td align="center" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="center" valign="top" class="box-white" id="leftFrm"><iframe frameborder=0 scrolling=auto src="recommend_channel_tree.jsp?FieldID=<%=FieldID%>&ChannelID=<%=ChannelID%>" style=height:100%;visibility:inherit;width:100%;></iframe></td>
