...
<div class="br-logo">
    ...
    <div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
        <iframe src="report2018.jsp" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
	...
	<script>
        ...
        $(function(){
            ...
            $("#system-menu-cms-report").addClass("active");
            //$("#system-menu-report").addClass("active");
			  ...
			  if($('body').hasClass('collapsed-menu')) {
				...
				if(targ) {
                  ...
                  menuText.css({
				   ...
				   $("#system-menu-report").css("display","block");
				  ...
				  menuText.addClass('d-lg-none');
				   $("#system-menu-report").css("display","none");
