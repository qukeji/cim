...
<div class="br-mainpanel br-mainpanel-file" id="js-source">  
        ...
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <span class="breadcrumb-item active">系统管理 / 工作量统计 / 部门发稿量</span>
        </nav>
        </div><!-- br-pageheader -->
     ...
     <div class="search-box pd-x-20 pd-sm-x-30" id="SearchArea">
		<div class="search-content bg-white">
			<form name="search_form"  action="report_depart2018.jsp" method="post">
      		<div class="row">
				<!--用户信息-->
				<div class="wd-50 mg-b-30 mg-r-10 ht-40 d-flex align-items-center justify-content-start">部门:</div>
				<div class="mg-r-20 mg-b-40 search-item">
                <select class="form-control select2 wd-80" name="grop_data" id="grop_data">				
				</select>                                
				</div>	
...
<div class="br-pagebody pd-x-20 pd-sm-x-30">
		<div class="card bd-0 shadow-base">		
			<table class="table mg-b-0" id="content-table">
				<thead>
				  <tr>				
					<th class="tx-12-force tx-mont tx-medium">部门名称:</th>						
					<th class="tx-12-force tx-mont tx-medium hidden-xs-down">部门人数</th>  				
...
%>
      <tr id="item_<%=Rs.getString("id")%>">
			...
			<td class="hidden-xs-down"><%=ReportUtil.getDepartUserCount(Rs.getInt("id"))%></td>		
