...
<div class="content_t1">
	<div class="content_t1_nav">当前位置：工作量统计 > 站点发稿量 </div>
...
<div class="viewpane_c1" id="SearchArea">
  ...
  <tr>
    <td width="20"> </td>
    <td><form name="search_form"  action="report_site.jsp" method="post">
...
<thead>
		<tr>
			<th class="v3" style="padding-left:10px;text-align:left;">站点名称</th>
