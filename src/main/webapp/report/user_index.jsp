...
<script> 
	...
	function ok(){
		...
		$('#userIDs', parent.window.frames["content_frame"].contentDocument).val(userId);
		$('#Usernames', parent.window.frames["content_frame"].contentDocument).attr("value",Username);
		$('#groupName', parent.window.frames["content_frame"].contentDocument).val(groupName);
...
<script>
	...
	function showUser(id){
		$.ajax({
			type:"GET",
			dataType:"json",
			url:"getUserList.jsp?GroupID="+id,
