<%@ page import="tidemedia.cms.system.*,tidemedia.cms.util.*,java.util.Date,tidemedia.cms.base.*,java.sql.*,
				tidemedia.cms.user.*"%>
...
//获取屏幕管理编号
Channel channel = ChannelUtil.getApplicationChannel("screen_charts");
int channelid = channel.getId() ;
int parent = channel.getParent();
int siteId = channel.getSiteID();
int site_channel = 0 ;
TableUtil tu=new TableUtil();
ResultSet rs=tu.executeQuery("select * from channel where site="+siteId+" and parent=-1 ");
while(rs.next()){
	site_channel=rs.getInt("id");
}
tu.closeRs(rs);
...
<body class="collapsed-menu email" id="withSecondNav" onLoad="init();">
	...
	<div class="br-subleft br-subleft-file">
		...
		<label class="sidebar-label pd-x-15 mg-t-20"></label>
			<div class="br-sideleft-menu">
				...
				<a href="daping_main.jsp" class="br-menu-link  menu-home">
				...
				<a href="daping_dataview.jsp" class="br-menu-link active menu-channel">
					<div class="br-menu-item">
    ...
    <div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
        <iframe src="../content/content2018.jsp?id=16178" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
...
//=============================================================================================================
			...
			var  url="../lib/channel_json.jsp?ChannelID=<%=site_channel%>";
				...
				{	   
                    if(i==0){
						html += '<li class="active"><a href="#" load="'+json_[i].load+'" channelid="'+json_[i].id+'">';
  						...
  						html += '<li class=""><a href="#" load="'+json_[i].load+'" channelid="'+json_[i].id+'">';
					}
