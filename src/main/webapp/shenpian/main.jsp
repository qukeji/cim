	...
	<div class="br-sideleft overflow-y-auto">
        ...
        <a href="Index2018.jsp" class="br-menu-link menu-explorer">
            <div class="br-menu-item">
                ...
                <span class="menu-item-label">移动审片</span>
            </div>
        </a>
		...
		<div class="br-mainpanel with-first-nav">
			...
			<div class="d-flex pd-30">
				<div class="td-logo theme-bg mg-r-10"><i class="tx-white fa fa-film tx-34"></i></div>
				<div class="">
                    <h4 class="tx-gray-800 mg-b-5">移动审片管理 </h4>
...
$(function() {
	...
	var task_status2="";
	var task_status3="";
    var url="shenpian_main_chart.jsp";
	 $.ajax({
            type:"GET",
            url: url,
            dataType:"json",
...
<script type="text/javascript">
    $(function()
    {
        var url="shenpian_data_statistics.jsp";
        $.ajax({
            type:"GET",
            url: url,
            dataType:"json",
