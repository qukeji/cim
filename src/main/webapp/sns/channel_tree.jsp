...
channel_tree_string = tree.listChannel_content_JS(12919,"tree",userinfo_session,100);
...
<div class="menu_top_2012">
	<div class="m_t_main">
		<div class="m_t_title"><img src="../images/sns.png" />社区管理</div>
	</div>
</div>
...
if (document.getElementById) {
	var tree = new WebFXTree('社区','javascript:show(-1)\" ChannelID=\"0');
