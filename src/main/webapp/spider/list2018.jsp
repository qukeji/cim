...
<head>
    ...
    <script language=javascript>
        ...
        function addSpider() 
		{
            ...
            dialog.setUrl("spider_add2018.jsp?GroupID=" + GroupID);
        ...
        function editSpider(id) 
		{
            ...
            dialog.setHeight(460);
            dialog.setUrl("spider_edit2018.jsp?id=" + id);
        ...
        function setField(id) 
		{
            ...
            dialog.setWidth(650);
            dialog.setHeight(460);
            dialog.setUrl("spider_field_list2018.jsp?Parent=" + id);
        ...
        function configSpider()
		{
            ...
            dialog.setUrl("spider_config.jsp");
            dialog.setTitle("采集配置");
            dialog.show();
        }   
		  function clear(id)
		{
			var url="list_clear2018.jsp?id="+id;
            var dialog = new top.TideDialog();
            dialog.setWidth(320);
		  ...
		  function del(id)
		{
			var url="list_del2018.jsp?id="+id;
            var dialog = new top.TideDialog();
            dialog.setWidth(320);
            dialog.setHeight(260);
            dialog.setUrl(url);
		...
		{
			var url="spider_enable2018.jsp?id="+id+"&flag="+flag;
            var dialog = new top.TideDialog();
            dialog.setWidth(320);
            dialog.setHeight(260);
            dialog.setUrl(url);
    ...
    <div class="br-mainpanel br-mainpanel-file" id="js-source">
        <div class="br-pageheader pd-y-15 pd-md-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
				<span class="breadcrumb-item active">采集系统</span>
            </nav>
        </div>
		<!-- br-pageheader -->
...
<tr id="jTip<%=j%>_id">
    ...
    <td class="hidden-xs-down">
        ...
        <a href="spider_test.jsp?id=<%=id%>" target="_blank" class="btn btn-info btn-sm mg-r-5 mg-b-5 tx-13">测试</a>
        <%if(Status==1){%>
        <div class="toggle-wrapper" style="top:5px;">
            <div class="toggle toggle-modern primary" data-toggle-on="true" field="<%=id%>" style="height: 25px; width: 60px;"><div class="toggle-slide"><div class="toggle-inner" style="width: 95px; margin-left: 0px;"><div class="toggle-on active" style="height: 25px; width: 47.5px; text-indent: -8.33333px; line-height: 25px;">ON</div><div class="toggle-blob" style="height: 25px;width: 25px;margin-left: -12.5px;"></div><div class="toggle-off" style="height: 25px;width: 47.5px;margin-left: -12.5px;text-indent: 8.33333px;line-height: 25px;">OFF</div></div></div></div>
        </div></button>
        <%}else if(Status==0){%>
		<div class="toggle-wrapper" style="top:5px;">
            <div class="toggle toggle-modern primary" data-toggle-on="false" field="<%=id%>" style="height: 25px; width: 60px;"><div class="toggle-slide"><div class="toggle-inner" style="width: 95px; margin-left: 0px;"><div class="toggle-on" style="height: 25px; width: 47.5px; text-indent: -8.33333px; line-height: 25px;">ON</div><div class="toggle-blob" style="height: 25px;width: 25px;margin-left: -12.5px;"></div><div class="toggle-off active" style="height: 25px;width: 47.5px;margin-left: -12.5px;text-indent: 8.33333px;line-height: 25px;">OFF</div></div></div></div>
        </div>
		<%}%>
    </td>
</tr>
