...
{	
   ...
   <body class="" onload="init();">
    <div class="bg-white modal-box">
      <form name="form" action="spider_add2018.jsp" method="post" onSubmit="return check();">
	       		  ...
	       		  <li class="block">	       		  	 
			              ...
			              <label class="wd-230">
			               ...
			               <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="transfer" id="transfer" rows="3" class="form-control" placeholder=""></textarea>
				              <br>(每行一个地址)
 						  </div>	
	       		  	  </div>
	       		  	  ...
	       		  	  <!--标识名-->
	       		  	   <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">采集网址：</label>
			               <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="Url" id="Url" rows="3" class="form-control" placeholder=""></textarea>			              
 						  </div>										            
	       		  	  </div>
	       		  	  <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">一次性采集地址：</label>
			             <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="Url_First" id="Url_First" rows="3" class="form-control" placeholder=""></textarea>			              
 						  </div>									            
	       		  	  </div>
			            ...
			            <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="ListStart"  rows="3" class="form-control" placeholder=""></textarea>			              
 					   </div>
			              ...
			              <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="ListEnd"  rows="3" class="form-control" placeholder=""></textarea>			              
 					      </div>							            
	       		  	  </div>
	       		  	  <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">标题关键词：</label>
			              <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="TitleKeyword"  rows="3" class="form-control" placeholder=""></textarea>			              
			              ...
			              <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="ListReg" rows="3" class="form-control" placeholder=""></textarea>
				            </div>									            
	       		  	  </div> 
					   <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">链接正则表达式：</label>
			                <label class="wd-230">
			                <input name="HrefReg" id="HrefReg" size="32" class="form-control" placeholder="" type="text">
			               </label>	
			               ...
			               <label class="wd-230">
			                <input name="Program" id="Program" size="32" class="form-control" placeholder="" type="text">
			               </label>							             
	       		  	  </div>
					  <div class="row">                   		  	  		   		  	  		  
                       ...
                       <div class="row">                   		  	  	
			               ...
			               <label class="wd-230">
			                <input name="Channel" id="Channel"  class="form-control" placeholder="" type="text">
			               </label>							             
	       		  	  </div>		
                       <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">图片路径：</label>
			               <label class="wd-230">
			                <input name="ImageFolder" id="ImageFolder"  class="form-control" placeholder="" type="text">
			               </label>							             
	       		  	  </div>	
                      <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">采集周期：</label>
			               <label class="wd-230">
			                <input name="Period" id="Period"  class="form-control" placeholder="" type="text">
			               </label>		
			              ...
			              <label class="rdiobox">
			                <input name="IsDownloadImage" id="IsDownloadImage_1" type="radio" value="1" class="textfield" checked><span>需要</span>
			              </label>
				          <label class="rdiobox">
			                <input name="IsDownloadImage" id="IsDownloadImage_0" type="radio" value="0" class="textfield"><span>不需要</span>
			              </label>
	       		  	  </div>
					  <div class="row">                  		  	  	
	   		  	  		  <label class="left-fn-title">文档默认状态：</label>
			              <label class="rdiobox">
			                <input name="ItemStatus" id="ItemStatus_1" type="radio" value="1" class="textfield" checked><span>已发</span>
			              </label>
				          <label class="rdiobox">
					   ...
					   <div class="row">                  		  	  	
			              ...
			              <label class="rdiobox">
			                <input name="ItemGid" checked id="ItemStatus_1" type="radio" value="1" class="textfield"><span>是</span>
			              </label>
				          <label class="rdiobox">
			                <input name="ItemGid" id="ItemStatus_0"  type="radio" value="0" class="textfield"><span>否</span>
			              </label>
	       		  	  </div>
	       		  </li>
