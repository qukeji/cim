...
{	
   ...
   <body class="" onload="init();">
    <div class="bg-white modal-box">
      <form name="form" action="spider_field_add2018.jsp" method="post" onSubmit="return check();">
	       	  ...
	       	  <ul>
	       		  ...
	       		  <li class="block">	       		  	 
					   ...
					   <div class="row">                   		  	  	
			              ...
			              <label class="wd-230">
			                <input name="Field" id="Field" class="form-control" placeholder="" type="text">
			              </label>									            
	       		  	  </div>
					  <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">内容对象：</label>
			              <label class="wd-230">
			                <input name="rule" id="rule" class="form-control" placeholder="" type="text">			                
						  </label>									            
	       		  	  </div>	
                        <div class="row">                   		  	  	
			               ...
			               <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="CodeStart" rows="3" class="form-control" placeholder=""></textarea>			              
 						  </div>										            
	       		  	  </div>
	       		  	  <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">结束代码：</label>
			             <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="CodeEnd" rows="3" class="form-control" placeholder=""></textarea>			              
 						  </div>									            
	       		  	  </div>
			            ...
			            <div class="pd-l-0 pd-r-0 wd-300">
				              <textarea name="CodeReg"  rows="3" class="form-control" placeholder=""></textarea>			              
 					   </div>
			             
	       		  	  </div>
	       		  	  <div class="row">                   		  	  	
	   		  	  		  <label class="left-fn-title">复制配置：</label>
			               <label class="wd-230">
			                <input name="id2" id="id2" class="form-control" placeholder="" type="text">
			              </label>								            
	       		  	  </div>                                     
	       		  </li>       	    
	       	  </ul>
