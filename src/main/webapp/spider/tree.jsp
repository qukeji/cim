<%@ page import="tidemedia.cms.system.*,tidemedia.cms.spider.*"%>
...
<%if(Action.equals("Delete")){%>
	...
	{
		parent.frames["ifm_right"].location = "list.jsp";
	}
<%}%>
...
function newGroup()
{
	if (tree.getSelected()) 
	 ...
	 var	dialog = new top.TideDialog();
		...
		dialog.setUrl("spider/group_add.jsp?GroupID="+GroupID);
		dialog.setTitle("新建采集组");
		dialog.show();
}
...
function editGroup()
{
    if (tree.getSelected()){ 
	 ...
	 var	dialog = new top.TideDialog();
		dialog.setWidth(300);
		dialog.setHeight(200);
		dialog.setUrl("spider/group_edit.jsp?GroupID="+GroupID);
		dialog.setTitle("编辑采集组");
		dialog.show();
}
