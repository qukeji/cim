  ...
  var fieldName = "SubjectName";
	function next()
	{
		...
		if(result!="false"){
			...
			parent.$("#SubjectName").prop("value",strs[0]);
			parent.$("#SubjectId").prop("value",strs[1]);
			top.TideDialogClose();
		}
		var result2 = window.frames["right"].getRadio2();
		var strs2= new Array(); //定义一数组 
        strs2=result2.split(",");
		if(result2!="false"){
		   
			parent.$("#SubjectuUserId").prop("value",strs2[0]);
			top.TideDialogClose();
		}
	}
</script>
			...
			<div class="d-flex ht-100p-force justify-content-between">
				...
				<div class="right-box wd-700">
					<div id="rightTd" style="height: 100%;">      
						<iframe src="documentHref_right.jsp?id=<%=ChannelID%>&doc_type=<%=doc_type%>" name="right" id="right" style="width: 100%;height: 100%;" scrolling="auto" frameborder="0"></iframe>
					</div>
				</div><!-- right-box -->
