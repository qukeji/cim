  ...
  var fieldName = "SubjectName";
	function next()
	{
		...
		if(result!="false"){
			...
			parent.$("#projectName").prop("value",strs[0]);
			parent.$("#projectId").prop("value",strs[1]);
			top.TideDialogClose();
		}
			...
			<div class="d-flex ht-100p-force justify-content-between">
				...
				<div class="right-box wd-700">
					<div id="rightTd" style="height: 100%;">      
						<iframe src="documentHref_project_right.jsp?id=<%=ChannelID%>&doc_type=<%=doc_type%>" name="right" id="right" style="width: 100%;height: 100%;" scrolling="auto" frameborder="0"></iframe>
					</div>
				</div><!-- right-box -->
...
//========================================================================
		$.sidebarMenu = function(menu) {
			...
			$(menu).on('click', 'li a', function(e) {
				...
				window.frames["right"].location = "documentHref_project_right.jsp?id="+channelid+"&doc_type=<%=doc_type%>";
			});
		}	
	</script>
</body>
