...
while(Rs.next())
{
	...
	{
%>
		 <tr No="<%=j%>" ItemID="<%=id_%>" contentHref="<%=contentHref%>" subjectid="<%=GlobalID%>" subjectname="<%=Title%>" OrderNumber="<%=OrderNumber%>"  status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item">
