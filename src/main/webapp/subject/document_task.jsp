...
<%
    ...
    Channel project = ChannelUtil.getApplicationChannel("task_project");//选题
    int channelId_project = project.getId();
...
$(function(){
    ...
    $("#field_projectName").after("\r\n<label><input type=\"button\" value=\"选择\" onclick=\"getproject()\" class=\"btn btn-primary tx-size-xs mg-l-10\"></label>");
...
function selectByKeyword()
{
 ...
 function getproject(){
        ...
        var url = "documentHref_project_index.jsp?ChannelID=<%=channelId_project%>&fieldName=juxian_liveid";
