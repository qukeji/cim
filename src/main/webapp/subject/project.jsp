...
String dir="project";
Channel task_project = ChannelUtil.getApplicationChannel("task_project");
int childChannel = task_project.getId() ;
int company = userinfo_session.getCompany();
if(company>0 && task_project.isShareChannel())
{
	Channel channel_ = ChannelUtil.getCompanyChannelByShare(task_project, company);
	if(channel_!=null)
		childChannel = channel_.getId();
}
int parent = task_project.getParent();
		...
		function get_menu_html(json,childChannel)
		{
			...
			{										
				...
				{	 
                        ...
                        }else{	html += '<li class=""><a href="#" load="'+json_[i].load+'" channelid="'+json_[i].id+'">';
    			        }
