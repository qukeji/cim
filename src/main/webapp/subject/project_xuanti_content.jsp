...
<head>
	...
	<script>
...

		{
			...
			window.open("../subject/approve_preview.jsp?ItemID=" + id + "&ChannelID="+LinkChannelID);
		}
		...
		function content_gather_addDocument(channelid)
		{
			...
			{    $.ajaxSettings.async = false;
				$.getJSON("../content/document_getnew.jsp?id="+parent.channelid, function(o){
					...
					parent.document.form.ItemID.value = o.itemid;
					parent.document.form.Action.value = "Update";
					url="../subject/sidebar_new_content_bychannel.jsp?ChannelID="+channelid+"&ItemID=0&project_gid="+globalid+"&LinkChannelID="+ChannelID;
...
<div class="br-mainpanel br-mainpanel-file" id="js-source">
	...
	<div class="d-flex align-items-center justify-content-start mg-b-20 mg-sm-b-30">
		<div class="btn-group mg-l-10 hidden-xs-down mg-l-auto">
			...
			<a href="javascript:;" class="btn btn-outline-info" onClick="editDocument1();">查看</a>
...
//System.out.println("ids="+ids);
				...
				<tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>"  status="<%=Status%>" GlobalID="<%=GlobalID%>"  id="item_<%=id_%>" class="tide_item">
					...
					<td class="hidden-xs-down"><%=start_time%></td>
					<td class="hidden-xs-down"><%=task_statusDesc%></td>
					...
					<a href="javascript:Preview2('<%=id_%>');" class="svg-icon fa-svg-icon svg-fa-check-circle" viewBox="0 0 512 512" title="预览"><i class="fa fa-eye tx-18 handle-icon" aria-hidden="true"></i></a>
                    ...
                    <a href="javascript:delItem('<%=id_%>');" class="svg-icon fa-svg-icon svg-fa-check-circle" viewBox="0 0 512 512" title="删除"><i class="fa fa-trash-o tx-18 handle-icon" aria-hidden="true"></i></a>
