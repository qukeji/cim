...
<body class="collapsed-menu email" onLoad="">
	...
	<div class="br-mainpanel">      
      <iframe src="renwu_select_content.jsp?ChannelID=<%=ChannelID%>&LinkChannelID=<%=LinkChannelID%>&GlobalID=<%=GlobalID%>&fieldgroup=<%=fieldgroup%>" id="template_frame" style="width: 100%;height: 100%;"  scrolling="auto" frameborder="0" onload="changeFrameHeight(this)"></iframe>  
    </div><!-- br-mainpanel -->
...
//========================================================================
		$.sidebarMenu = function(menu) {
			...
			$(menu).on('click', 'li a', function(e) {
                ...
                changeFrameSrc( window.frames["template_frame"] , "renwu_select_content.jsp?ChannelID="+ChannelID+"&LinkChannelID="+LinkChannelID+"&GlobalID="+GlobalID+"&fieldgroup="+fieldgroup+"&LinkChannelID2="+LinkChannelID2 );						
			});
		}	
    </script>
</body>
