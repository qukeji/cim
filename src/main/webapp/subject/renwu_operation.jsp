...
<%
    ...
    System.out.println(operation_userid+"哈哈哈哈"+userinfo_session.getId()+"jdnfcccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc");
...
<div class="br-header">
    ...
    <div class="br-header-right">
        <div class="btn-box" >
            ...
            <%}%>
            <%if(TaskStatus==0&&operation_userid==userinfo_session.getId()){%>
            <button type="button" class="btn btn-secondary tx-size-xs mg-r-5" onclick="Save(1);">开始任务</button>
            <%}%>
            <%if(TaskStatus==1&&operation_userid==userinfo_session.getId()){%>
            <button type="button" class="btn btn-secondary tx-size-xs mg-r-5" onclick="Save(2);">完成</button>
            <%}%>
            <%if(TaskStatus==2&&user==userinfo_session.getId()){%>
            <button type="button" class="btn btn-secondary tx-size-xs mg-r-5" onclick="Save(3);">确认完成</button>
            <%}%>
