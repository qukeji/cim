...
function next(type)
{
	...
	if (channelid!=""&&(channelid.indexOf(",")<0)){
        if(type==1){
    		...
    		window.open("../lib/webIndex.jsp");  
    	}else{
            console.log(channelid);
    		window.open("../subject/project_subject_document.jsp?ChannelID="+channelid+"&project_gid="+project_gid+"&LinkChannelID="+project_channeldid+"");  
    	}
	}else{
...
<body class="collapsed-menu email">
	...
	<script>
	        var ChannelId2 = <%=ChannelID_Source%> ;
       	    var  url="../lib/channel_json.jsp?ChannelID="+ChannelId2;
