...
public String getHtml(String result,String time,int next,int end,int endStep,String userNames,String userIds,int approveId,int action){
	...
	String html = "";
	html += "<div id=\"approve2\" class=\"mg-y-5 sh-item d-flex justify-content-between align-items-center\"  user=\""+userIds+"\" end=\""+end+"\" approveId=\""+approveId+"\" >";
	...
	if(next==1){
		html += "<textarea id=\"approve\" class=\"form-control ht-100 mg-t-10\" cols=\"5\"  placeholder=\"驳回理由，如审核通过则不需要输入\" user=\""+userIds+"\" end=\""+end+"\" approveId=\""+approveId+"\"></textarea>";
	}
