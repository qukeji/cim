...
//out.println("<script>top.TideDialogClose({suffix:'_3',recall:true,returnValue:{refresh:true,currPage:"+currPage+",rowsPerPage:"+rowsPerPage+"}});</script>");
...
<script type="text/javascript">
 ...
 <form name="form" method="post" action="error_log_del2018.jsp" >     
	    <div class="modal-body modal-body-btn pd-20 overflow-y-auto">
	        <div class="config-box mg-t-15">
	   		  	<div class="row">                   		  	  	
		  	  		  <label class="left-fn-title">你确定要删除该错误日志?</label>							            
	   		  	</div>	
                 <div class="row">                              				
