...
<%
	...
	if(id==1){
		loc = "license2018.jsp";
		active_style="menu-system-pingtai";
		active_style2="system-menu-pingtai";
		active_li="system-menu-license";
		
	}else if(id==2){
		loc = "parameter2018.jsp";
	    active_style="menu-system-pingtai";
		active_style2="system-menu-pingtai";
		active_li="system-menu-parameter";
	}else if(id==3){
		loc = "operate_log2018.jsp";
		active_style="menu-log";
		active_li="system-menu-cms-log";
		active_style2="system-menu-log";
		...
		active_style="menu-backup";
		active_li="system-menu-cms-backup";
		active_style2="system-menu-backup";
	}else if(id==8){
		loc = "manager2018.jsp";
		active_style="menu-manager";
		active_li="system-menu-cms-manager";
		active_style2="system-menu-manager";

	}else if(id==9){
		loc = "content_quartz2018.jsp";
		active_style="menu-quartz";
		active_li="system-menu-cms-quartz";
		active_style2="system-menu-quartz";

	}else if(id==10){
		loc = "../photo/photo_scheme2018.jsp";
		active_style="menu-system-pingtai";
		active_style2="system-menu-pingtai";
		active_li="system-menu-photoscheme";

	}else if(id==11){
		loc = "../approve/approve_scheme.jsp";
		active_style="menu-system-pingtai";
		active_style2="system-menu-pingtai";
		active_li="system-menu-approve";

	}else if(id==12) {
		loc = "../watermark/watermark_list.jsp";
		active_style="menu-system-pingtai";
		active_style2="system-menu-pingtai";
		active_li="system-menu-watermark";
	}else if(id==13) {
		loc = "login_verify.jsp";
		active_style="menu-system-pingtai";
		active_style2="system-menu-pingtai";
		active_li="system-menu-loginverify";
	}
%>
