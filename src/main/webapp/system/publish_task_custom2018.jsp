...
else if(Action.equals("Clear"))
{
	...
	response.sendRedirect("publish_task_custom2018.jsp?a=a"+queryString);return;
}
...
<div class="br-pagebody pd-x-20 pd-sm-x-30">
       	<div class="toolbar_l">       	
            ...
            <ul class="toolbar2">
                <li class="first"><a href="../publish/publish_task_custom2018.jsp?Status=0">待发布文件</a></li>
                <li><a href="../publish/publish_task_custom2018.jsp?Status=1">已发布文件</a></li>
                <li><a href="../publish/publish_task_custom2018.jsp?Status=2">正在发布</a></li>
                <li class="last"><a href="../publish/publish_task_custom2018.jsp?Status=3">发布失败</a></li>
...
%>
		<tr>
		 ...
		 <%}%>			
			...
			<td class="hidden-xs-down"><%=siteName%></td>
...
<%}%>
<td class="hidden-xs-down"><%=Message%></td>
		  <td class="hidden-xs-down"><%if(Status==3||Status==2){%><a href="#" class="btn btn-info btn-sm tx-13" onclick="Details(<%=id%>);">查看错误</a><%}%>
