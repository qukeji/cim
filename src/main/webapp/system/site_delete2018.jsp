...
int fid=Util.getIntParameter(request,"id");
Site site=CmsCache.getSite(fid);
String	Submit	= getParameter(request,"Submit");
if(!Submit.equals("")){
	site.setActionUser(userinfo_session.getId());
    site.Delete(fid);
	out.println("<script>top.TideDialogClose({refresh:'left',returnValue:{close:2},returnNavValue:{currentid:0,parentid:-1,type:2,site:true}});</script>");
...
<script type="text/javascript">
 ...
 <form name="form" method="post" action="site_delete2018.jsp" >     
	    <div class="modal-body modal-body-btn pd-20 overflow-y-auto">
	        <div class="config-box mg-t-15">
	   		  	<div class="row">                   		  	  	
		  	  		  <label class="left-fn-title">你确定删除该站点吗?</label>							            
	   		  	</div>	
                 <div class="row">                              				
