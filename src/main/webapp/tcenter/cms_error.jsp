...
<%if(messageType==5){%><script language=javascript>if (top.location != self.location)top.location="<%=(request.getRequestURL()+"").replace("cms_error.jsp","main_system2018.jsp?Flag=2")%>";</script><%}%>
</head>
