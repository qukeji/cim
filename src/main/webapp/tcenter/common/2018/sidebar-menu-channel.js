$(function(){
	...
	if(dir=="system"||dir=="template"||dir=="user"||dir=="publish"||dir=="report"||dir=="spider"){
		//$("#system-menu").css("display","block");
		$("#menu-system").addClass("active");
		$("#system-menu-"+dir).addClass("active");
	}else{
...
//	    }else{
//	        i_all.removeClass("fa-folder-open-o folder-open").addClass("fa-folder-o");
//	    }
        //自定义end
...
function sidebarMenu_show_back(checkElement,$this,callback){
    checkElement.slideDown(0, function() {
    	checkElement.addClass('menu-open');
  	});
