...
String channel_tree_string_14271 = tree.listChannel_content_JS(14271,"tree",userinfo_session,tree.getChannelNumber());
...
if (document.getElementById) {
	var tree = new WebFXTree('任务管理','javascript:show(14271)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	<%=channel_tree_string_14271%>
	document.write(tree);
