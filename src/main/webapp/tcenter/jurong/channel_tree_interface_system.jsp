...
String channel_tree_string_13097 = tree.listChannel_content_JS(13097,"tree",userinfo_session,tree.getChannelNumber());
...
if (document.getElementById) {
	var tree = new WebFXTree('线索管理','javascript:show(13097)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	<%=channel_tree_string_13097%>
	document.write(tree);
