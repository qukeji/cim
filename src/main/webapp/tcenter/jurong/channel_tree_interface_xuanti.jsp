...
String channel_tree_string_14270 = tree.listChannel_content_JS(14270,"tree",userinfo_session,tree.getChannelNumber());
...
if (document.getElementById) {
	var tree = new WebFXTree('热度排行','javascript:show(14270)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	<%=channel_tree_string_14270%>
	document.write(tree);
