...
int canExcel=0;//channel.getIsExportExcel();//是否导出Excel
int canWord=0;//channel.getIsImportWord();//是否导出world
...
function popup()
{
	...
	var url='./custom/popup.jsp?itemid='+ obj.id+'&channelid=<%=ChannelID%>';
	var	dialog = new top.TideDialog();
		dialog.setWidth(400);
...
<div class="content_t1">
    ...
    <div class="content_new_post">
		...
		<%if(canWord>0){%>
		<div class="top_button button_inline_block" onClick="word_import();">
				<div class="top_button_outer button_inline_block">
					<div class="top_button_inner button_inline_block">
						<span class="img"><img src="../images/icon/upload.png" /></span>
						<span class="txt">导入WORD</span>
					</div>
				</div>
		</div>
		<%}%>
		...
		<%if(canExcel>0){%>
		<div class="top_button button_inline_block" onClick="excel_export();">
				<div class="top_button_outer button_inline_block">
					<div class="top_button_inner button_inline_block">
						<span class="img"><img src="../images/icon/43.png" /></span>
						<span class="txt">导出EXCEL</span>
					</div>
				</div>
		</div>
		<%}%>
...
String ListSql = "select id,Title,Photo,Weight,reviewer,bespeak,GlobalID,User,rwzt,zpr,kssj,btsj,jssj,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews";
...
if(taskStatus>0)
{
	WhereSql += " and rwzt="+(taskStatus-1);
}
...
<div class="content">
	<div class="toolbar">
    	<div class="toolbar_l">
            ...
            <ul class="toolbar2">
                ...
                <li ><a href="javascript:list('taskStatus=1');">待审核</a></li>
                <li ><a href="javascript:list('taskStatus=2');">审核通过</a></li>
                <li ><a href="javascript:list('taskStatus=3');">毙稿</a></li>
                <li class="last"><a href="javascript:list('taskStatus=4');">已完成</a></li>
            </ul>
	...
	-->
				...
				<%}%>
				<li class="last"><a href="javascript:popup();">选题详情</font></a></li>
            </ul>
        </div>
...
<thead>
		<tr id="oTable_th">
    				...
    				<th class="v1"	align="center" valign="middle">执行人</th>
    				<th class="v1"	align="center" valign="middle">审核人</th>
    				<th class="v1"	align="center" valign="middle">任务状态</th>
    				<!--<th class="v1"	align="center" valign="middle">开始时间</th>
    				<th class="v1"	align="center" valign="middle">结束时间</th>-->
    				<th class="v4"  align="center" valign="middle">报题日期</th>
    				<th class="v4"  align="center" valign="middle">预约车辆</th>
...
while(Rs.next())
{
	...
	int rwzt = Rs.getInt("rwzt");
//	int zpr = Rs.getInt("zpr");
	String zpr	= convertNull(Rs.getString("zpr"));
	String reviewer	= convertNull(Rs.getString("reviewer"));
	String Title	= convertNull(Rs.getString("Title"));
	String kssj	= convertNull(Rs.getString("kssj"));
	String btsj	= convertNull(Rs.getString("btsj"));
	String jssj	= convertNull(Rs.getString("jssj"));
	String bespeak	= convertNull(Rs.getString("bespeak"));
	int IsPhotoNews = Rs.getInt("IsPhotoNews");
	int TopStatus = 0;System.out.println(Title);System.out.println(rwzt);
	if(IsTopStatus){
	...
	if(!kssj.equals("")){
		kssj=Util.FormatDate("yyyy-MM-dd HH:mm:ss",kssj);
	}
	if(!btsj.equals("")){
		btsj=Util.FormatDate("yyyy-MM-dd HH:mm:ss",btsj);
	}
...
%>
  <tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>"  status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item">
	...
	<td class="v1" align="center" valign="middle"><%=zpr%></td>
	<td class="v1" align="center" valign="middle"><%=reviewer%></td>
	<td class="v1" align="center" valign="middle"><%=rwzt_%></td>
	<!--<td class="v1" align="center" valign="middle"><%=kssj%></td>
	<td class="v1" align="center" valign="middle"><%=jssj%></td>-->
    <td class="v4" > <%=btsj%></td>
    <td class="v4" > <%=bespeak%></td>
...
var menu = [
  ...
  {'<img src="../images/inner_menu_edit.gif" title="查看详情"/>查看详情':function(menuItem,menu) {popup()(); }},
