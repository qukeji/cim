...
<div class="frame">
	<div class="frame_tool">
    	<div class="frame_tool_l">
        	<div class="frame_logo"><a href="<%=basePath%>tcenter/main.jsp">tidemedia center</a></div><span class="frame_tool_arr">></span><div class="frame_product_name">热度排行</div>
        </div>
...
<div class="header_menu" id="spider">
	<ul>
        <li id="home_manage" href="custom/index_interface_xuanti.jsp"><a href="javascript:menu('manage');">热度排行</a></li>
...
<div class="frame_main" name="frame_main" id="frame_main"  frameborder="no"  border="0"><!--  name="frame_main" id="frame_main" frame_main层的高度需要js算出来，高度=浏览器高度-73px，iframe的高度也一样 -->
	<!-- iframe内容 -->
	<iframe id="main" name="main" frameborder="0" scrolling="no" border="0" style="width:100%;" src="./custom/index_interface_xuanti.jsp"></iframe>
