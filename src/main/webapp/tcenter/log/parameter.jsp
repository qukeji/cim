...
<script language="javascript">
	...
	function Details(id, code) {
		if (code == 'log_cleaning') {
			...
			dialog.setUrl("parameter_edit.jsp?id=" + id);
	...
	function del(id) 
	{
		...
		//dialog.setSuffix('_3');
		dialog.setUrl("parameter_del.jsp?id="+id+"&currPage=<%=currPage%>&rowsPerPage=<%=rowsPerPage%>");
		dialog.setTitle("删除参数");
		dialog.show();	
	}

	function addParameter() {
		var url = 'parameter_add.jsp';
		var dialog = new top.TideDialog();
		dialog.setWidth(580);
	...
	function gopage(currpage) {
		var url = "parameter.jsp?currPage=" + currpage + "&rowsPerPage=<%=rowsPerPage%><%=querystring%>";
		this.location = url;
	}
	...
	<div class="br-mainpanel br-mainpanel-file" id="js-source">
		...
		<div class="br-pageheader pd-y-15 pd-md-l-20">
			<nav class="breadcrumb pd-0 mg-0 tx-12">
				<span class="breadcrumb-item active">系统管理 / 系统参数</span>
			</nav>
		</div>
		<!-- br-pageheader -->
