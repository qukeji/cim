...
<body class=" email"  onLoad="init();">
    ...
    <div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
        <iframe src="navigation_content.jsp" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
	...
	<script>	
        ...
        $(function(){
			...
			$("#system-menu-navigation-product").addClass("active");
