...
if(haschild!=0 || level_==0)
{
	...
	String sql = "select id,Title,Level,Parent,ordernumber, hasNextLevel from navigation where Parent="+itemid_+" order by ordernumber desc";
	...
	while(rs.next())
	{
		...
		if(hasN == 0)
		{                                                                                   
			str +="<li class=\"no_arrow\" hasNext=\""+hasN+"\" itemid=\""+itemid+"\" level=\""+Level+"\"><a href=\"#\">"+Title+"</a><i class=\"fa fa-caret-right\"></i></li>";
		}
		else
		{
			str +="<li class=\"\" hasNext=\""+hasN+"\" itemid=\""+itemid+"\" level=\""+Level+"\"><a href=\"#\">"+Title+"</a><i class=\"fa fa-caret-right\"></i></li>";
		}
	}
	str += "</ul></div>";
