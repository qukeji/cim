...
<body class="" >
    <div class="bg-white modal-box">
	  <form name="form" action="notice_edit.jsp" method="POST" onSubmit="return check();">     
	        ...
	        <div class="config-box">	
               <ul>
					...
					<div class="row">                   		  	  	
						...
						<label class="wd-300">
							<input name="Title" class="form-control" placeholder="" type="text" value="<%=notice.getTitle()%>">
						</label>									            
					</div>
					<div class="row">                   		  	  	
						<label class="left-fn-title">开始时间：</label>
						<label class="wd-300" >
							<input value="<%=notice.getStartDate().replace(".0","")%>" id="StartDate" name="StartDate" class="date form-control" type="text" >
						</label>									            
					</div>
					<div class="row">                   		  	  	
						<label class="left-fn-title">结束时间：</label>
						<label class="wd-300" >
							<input value="<%=notice.getEndDate().replace(".0","")%>" id="EndDate" name="EndDate" class="date form-control"  type="text" >
						</label>									            
					</div>
