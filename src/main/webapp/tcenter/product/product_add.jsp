...
<body  onload="">
	...
	<form name="form" method="post" action="product_add.jsp" onSubmit="return check();">
				...
				<ul>
					...
					<li class="block">
						...
						<div class="row">
							...
							<label class="wd-300">
								<div class='toggle-wrapper'>
									<div class='toggle toggle-light primary' data-toggle-on='true' field='Status'></div>
								</div>
							</label>
						...
						<div class="row">                   		  	  	
							...
							<label class="wd-300">
								<select class="form-control wd-230 ht-40 select2" name="group">
									<option value="1" <%if(GroupID==1){%>selected="selected"<%}%>>运营支撑</option>
									<option value="2" <%if(GroupID==2){%>selected="selected"<%}%>>应用发布</option>
									<option value="3" <%if(GroupID==3){%>selected="selected"<%}%>>资源汇聚</option>
									<option value="4" <%if(GroupID==4){%>selected="selected"<%}%>>生产工具</option>
									<%
									...
									%>
									<option value="<%=id%>" <%if(GroupID==id){%>selected="selected"<%}%>><%=title%></option>	
									<%
										}
									}
									%>
						...
						<div class="row">
							...
							<input name="isview" id="isview" type="hidden" value="0">
						</div>
						<div class="row">
