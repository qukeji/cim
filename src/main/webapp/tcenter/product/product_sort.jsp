...
if(!Submit.equals("") && ItemID!=0)
{	 
	
	OrderNumber = getIntParameter(request,"Number");

	Product item = new Product();
	item.setUserId(userinfo_session.getId());
	item.Sort(ItemID,Direction,OrderNumber,GroupID);
...
<body onload="init();" scroll="no">
	<div class="bg-white modal-box" >
		<form name="form" action="product_sort.jsp" method="post" onSubmit="return check();">
			...
			<div class="modal-body modal-body-btn pd-20 overflow-y-auto">
				<div class="config-box">
					<div class="row"> 
						<label>
							<label class="rdiobox">
								<input type="radio"name="Direction" value="0" checked id="Direction_up" ><span>向上移动</span>
							</label>
							<label class="rdiobox">
								<input type="radio" name="Direction" value="1" id="Direction_down" ><span>向下移动</span>
							</label>
						</label>
