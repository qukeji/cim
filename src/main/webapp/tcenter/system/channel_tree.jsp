...
function init()
{
	...
	{
		parent.frames["ifm_right"].location = "login_log.jsp";
	}
}
...
<div class="menu_top_2012">
	<div class="m_t_main">
		<div class="m_t_title"><img src="../images/sns.png" />日志管理</div>
	</div>
</div>
...
if (document.getElementById) {
	var tree = new WebFXTree('日志管理','javascript:show(17563)\" ChannelID=\"0');
	tree.setBehavior('classic');
//	var a = new WebFXTreeItem('1','\" ChannelID=\"100');
//	tree.add(a);

	tree.add(new WebFXTreeItem("登录日志","javascript:show(1)"));
	tree.add(new WebFXTreeItem("系统参数","javascript:show(2)"));
