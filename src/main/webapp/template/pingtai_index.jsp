...
<div class="br-logo">
    ...
    <div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
        <iframe src="template_list2018.jsp" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
	...
	<script>
        $(function(){
			'use strict';
            $(".menu-template").addClass("active");
             $("#system-menu").addClass("active");
			$("#system-menu-cms-template").addClass("active");
			...
			$(document).on('mouseover', function(e){
			  ...
			  if($('body').hasClass('collapsed-menu')) {
				...
				if(targ) {
                  ...
                  $("#system-menu-template").css("display","block");
				} else {
				  ...
				  $("#system-menu-template").css("display","none");
				}
			  }
			});
...
//========================================================================
		$.sidebarMenu = function(menu) {
			...
			$(menu).on('click', 'li a', function(e) {
                ...
                changeFrameSrc( window.frames["content_frame"] , "../template/template_list2018.jsp?GroupID="+GroupID )	;
			});
		}	
