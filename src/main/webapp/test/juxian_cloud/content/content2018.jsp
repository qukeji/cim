...
int itemid = getIntParameter(request,"itemid");
	System.out.println("itemid是"+itemid);
...
if(channel.getListProgram().length()>0 && uri.endsWith("/content/content2018.jsp")){
	if(channel.getListProgram().endsWith("content_upgrade_log.jsp")){
		response.sendRedirect(channel.getListProgram()+"?id="+id+"&itemid="+itemid);
	}else{
