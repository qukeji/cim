...
<%
    ...
    Channel upgradelLogChannel = CmsCache.getChannel("upgrade_log");
%>
<%!
...
<div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
    <iframe src="../content/content2018.jsp" id="content_frame" style="width: 100%;height: 100%;" frameborder="0"
...
//						}						
    ...
    function backToOne(ids) {
        ...
        if (current) {
            ...
            if(channelid==<%=upgradelLogChannel.getId()%>){
                changeFrameSrc(window.frames["content_frame"], "../content/content2018.jsp?id=" + current+"&itemid=<%=itemid%>");
            }else{
