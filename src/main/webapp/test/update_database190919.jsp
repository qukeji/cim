...
//tu_user.executeUpdate("alter table tide_products add Isview int(11) default 0");
...
//2019-08-20
//一稿多发增加推荐设置表
//tu.executeUpdate("CREATE TABLE channel_recommend (id int(11) unsigned NOT NULL auto_increment,ChannelID int(11) NOT NULL,RelationID int(11) NOT NULL,ChannelRelation1 int(1) default 0,ChannelRelation2 int(1) default 0,RelationchannelType int(1) NOT NULL default 0,Operation int(1) NOT NULL,Relationship varchar(255) NOT NULL default '默认关系',CreateDate datetime,PRIMARY KEY  (`id`))");
//2019-08-27
//新增七牛云字段
...
//2019-09-25  稿件审核表新增审核类型字段  channelcode
