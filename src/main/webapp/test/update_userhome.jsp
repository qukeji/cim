...
// 2017 -01-17 增加定时发布表
//tu.executeQuery("CREATE TABLE `tidecms_to_publish` (`id` int(10) unsigned NOT NULL AUTO_INCREMENT,`globalid` int(10) DEFAULT NULL,`publishtime` varchar(255) //DEFAULT '',`republishtime` varchar(255) DEFAULT NULL,PRIMARY KEY (`id`))ENGINE=MyISAM AUTO_INCREMENT=350 DEFAULT CHARSET=utf8 ");
...
//2018-02-08
//建立社区相关信息表 RootChannelId为默认CMS 社区管理频道编号，有需要可以变更
      int RootChannelId=12919;
		
		//建立用户表
		int UserChannelID=CreateChannel(RootChannelId, "注册用户","tidehome_user");
		createField("Password","密码","text", "", UserChannelID, "", 0, 0);
		createField("Email","邮箱","text", "", UserChannelID, "", 0, 0);
		createField("Province","所在地","text", "", UserChannelID, "", 0, 0);
		createField("City","所在地城市","text", "", UserChannelID, "", 0, 0);
		createField("Truename","真实姓名","text", "", UserChannelID, "", 0, 0);
		createField("Phone","电话","text", "", UserChannelID, "", 0, 0);
		createField("Address","通讯地址","text", "", UserChannelID, "", 0, 0);
		createField("Supper","超级管理员","text","0", UserChannelID, "", 0, 0);
		createField("Type","什么方式登录","text", "0", UserChannelID, "", 0, 0);
		createField("Verify_Time","注册邮件有效期","number", "0", UserChannelID, "", 0, 0);
		createField("Verify_Time2","找回密码邮件有效期","number", "0", UserChannelID, "", 0, 0);
		createField("avatar","头像","image", "", UserChannelID, "", 0, 0);
		createField("code","注册时验证码","text", "", UserChannelID, "", 0, 0);
		createField("confirm","注册时是否验证","number", "0", UserChannelID, "", 0, 0);
		createField("code_pass","找回密码验证码","text", "", UserChannelID, "", 0, 0);
		createField("confirm_pass","找回密码验证","number", "", UserChannelID, "", 0, 0);
		createField("sessionTime","session的产生时间","text", "", UserChannelID, "", 0, 0);
		createField("session","sessionid","text", "", UserChannelID, "", 0, 0);
		createField("IP","IP地址","text", "", UserChannelID, "", 0, 0);
		createField("serial","序列号","text", "", UserChannelID, "", 0, 0);
		createField("sex","性别","number", "0", UserChannelID, "", 0, 0);
		createField("birthday","生日","datetime", "", UserChannelID, "", 0, 0);
		createField("id_card","身份证","text", "", UserChannelID, "", 0, 0);
		createField("profession","专业","text", "", UserChannelID, "", 0, 0);
		createField("qq","QQid","text", "", UserChannelID, "", 0, 0);
		createField("sina","新浪ID","text", "", UserChannelID, "", 0, 0);
		createField("weixin","微信ID","text", "", UserChannelID, "", 0, 0);
		createField("lastLogin","最后登录日期","datetime", "", UserChannelID, "", 0, 0);
		//建立评论表
		int CommentChannelID=CreateChannel(RootChannelId,"用户评论","tidehome_comment");
		createField("item_gid","文章编号","number", "", CommentChannelID, "", 0, 0);
		createField("userid","用户编号","number", "", CommentChannelID, "", 0, 0);
		createField("parent","父评论编号","number", "0", CommentChannelID, "", 0, 0);
		createField("url","文章链接","text", "", CommentChannelID, "", 0, 0);
		createField("channel_name","栏目名称","text", "", CommentChannelID, "", 0, 1);
		createField("type","评论来源","number", "0", CommentChannelID, "", 0, 1);
		//建立收藏表
		int CollectChannelID=CreateChannel(RootChannelId,"用户收藏","tidehome_collect");
		createField("item_gid","文章编号","number", "", CollectChannelID, "", 0, 0);
		createField("author","文章作者","text", "", CollectChannelID, "", 0, 0);
		createField("userid","用户编号","number", "", CollectChannelID, "", 0, 0);
		createField("url","文章链接","text", "", CollectChannelID, "", 0, 0);
		createField("type","收藏类型","radio", "", CollectChannelID, "文章(1)\n图片(2)\n视频(3)", 1, 0);
		//建立爆料表
		int BrokeChannelID=CreateChannel(RootChannelId,"用户爆料","tidehome_baoliao");
		createField("video","视频","text", "", BrokeChannelID, "", 0, 0);
		createField("Photo2","图片2","image", "", BrokeChannelID, "", 0, 0);
		createField("Photo3","图片3","image", "", BrokeChannelID, "", 0, 0);
		createField("Photo4","图片4","image", "", BrokeChannelID, "", 0, 0);
		createField("Photo5","图片5","image", "", BrokeChannelID, "", 0, 0);
		createField("userid","用户编号","number", "", BrokeChannelID, "", 0, 0);
		//意见反馈表
		int FeedChannelID=CreateChannel(RootChannelId,"意见反馈","tidehome_feedback");
		createField("userid","用户编号","number", "", FeedChannelID, "", 0, 0);
		//图片表
		int PhotoChannelID=CreateChannel(RootChannelId,"图片","tidehome_images");
		createField("Priname","原文件名","text", "", PhotoChannelID, "", 0, 0);
		createField("Photoname","现文件名","text", "", PhotoChannelID, "", 0, 0);
		createField("Uid","用户ID","text", "", PhotoChannelID, "", 0, 0);
		//用户动作表
		int ActionChannelID=CreateChannel(RootChannelId,"用户动作表","tidehome_actions");
		createField("userid","用户编号","number", "", ActionChannelID, "", 0, 0);
		createField("url","文章链接","text", "", ActionChannelID, "", 0, 0);
		createField("item_gid","文章编号","number", "0", ActionChannelID, "", 0, 0);
		createField("ding","顶","number", "0", ActionChannelID, "", 0, 0);
		createField("cai","踩","number", "0", ActionChannelID, "", 0, 0);
		createField("vote","投票数","number", "0", ActionChannelID, "", 0, 0);
		createField("commentnum","评论数","number", "0", ActionChannelID, "", 0, 0);
		createField("collectnum","收藏数","number", "0", ActionChannelID, "", 0, 0);
		createField("author","文章作者","text", "", ActionChannelID, "", 0, 0);
		
		JSONObject ConfigJson=new JSONObject();
		ConfigJson.put("user", UserChannelID);
		ConfigJson.put("comment", CommentChannelID);
		ConfigJson.put("collect", CollectChannelID);
		ConfigJson.put("baoliao", BrokeChannelID);
		ConfigJson.put("feedback", FeedChannelID);
		ConfigJson.put("photo", PhotoChannelID);
		ConfigJson.put("action", ActionChannelID);
		Parameter p = new Parameter();
		p.setName("用户中心频道配置");
		p.setCode("sys_tidehome_config");
		p.setIsJson(1);
		p.setComment("用户中心频道配置");
		p.setIsTemplate(0);
		p.setContent(ConfigJson.toString());
		p.Add();
