...
<script language=javascript>
	...
	{
		if(tabCode == 'divSelectPhoto'){
			$('#photo').attr("src","../../../photo/editor_photo_select_right.jsp?flag=1&id=<%=photo_channelid%>");
		}else if(tabCode == 'divSelectBackPhoto'){
		    $('#backphoto').attr("src","../../../photo/editor_photo_select_right.jsp?flag=1&id=<%=channelId%>");
		}
	}
	...
	function Ok(){
		...
		//是否为回传图片库选择图片
		if(document.getElementById("divSelectBackPhoto").style.display!="none"){
...
<form action="" enctype="multipart/form-data" method="post"  name="image_form">
	<div class="config-box">
		<div class="row">
			...
			<label fcklang="DlgImgWidth">宽度：</label>
			...
			<label class="ckbox mg-b-0-force mg-l-20">
				<input type="checkbox" name="Thumbnail" id="Thumbnail" value="yes"><span for="Thumbnail">使用缩略图</span>
			</label>
        		<%--<label class="ckbox mg-b-0-force mg-l-20">
        		<input type="checkbox" name="keepbig" id="keepbig" value="yes"><span for="keepbig">保留原图</span>
        	</label>--%>
		</div>
		<div class="row">
			<label fcklang="DlgImgAlign">加水印：</label>
			<label>
...
<div id="divSelectBackPhoto" style="display: none">
	<table cellpadding="0" cellspacing="0" width="100%" height="100%">
		<tr>
			<td width="100%">
				<table cellpadding="1" cellspacing="1" align="center" border="0" width="100%" height="100%">
	...
	jQuery(function() {
		...
		uploader.on( 'uploadFinished', function() {
			...
			if(returnData!=""&&returnData!== undefined)
			{
				...
				window.parent.dialog.close(true);
			}
		});
