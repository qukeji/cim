...
<div class="br-logo">
	...
	<div class="br-sideleft overflow-y-auto">
		...
		<a href="ugc_main.jsp" class="br-menu-link  active menu-home">
        ...
        <!-- br-menu-link -->
         <a href="ugc_baoliao.jsp" class="br-menu-link menu-source">
            <div class="br-menu-item">
		...
		<div class="br-header">
			<div class="br-header-left">
				...
				<div class="hidden-md-down system-name"><a href="javascript:;"><i class=""></i>ugc数据管理</a></div>
			</div>
			<!-- br-header-left -->
		...
		<div class="br-mainpanel with-first-nav">
			...
			<div class="d-flex pd-30">
				<div class="td-logo theme-bg mg-r-10"><i class="tx-white fa fa-comments-o tx-36"></i></div>
				<div class="">
                    <h4 class="tx-gray-800 mg-b-5">UGC内容管理系统</h4>
					<p class="mg-b-0">本系统用于终端用户互动功能配置及互动数据查看和管理</p>	
					</div>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="theme-bg rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								...
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">社区内容数量</p>
					...
					<div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
						<div class="theme-bg-9 rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								...
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">评论内容数量</p>
					...
					<div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
						<div class="theme-bg-8 rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								...
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">爆料内容数量</p>
					...
					<div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
						<div class="theme-bg-7 rounded overflow-hidden">
							<div class="pd-25 d-flex align-items-center">
								...
								<div class="mg-l-20">
									<p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">反馈内容数量</p>
								...
								<div class="d-flex align-items-center justify-content-between">
									<div>
										<p class="tx-13 tx-uppercase tx-inverse tx-spacing-1 tx-18">
											<i class="fa fa-line-chart theme-tx-color mg-r-5"></i>UGC内容数据统计
										</p>										
									</div>									
								</div>
							</div>
    ...
    var url="ugc_main_chart.jsp";
	 $.ajax({
            ...
            success: function(data){
			    ...
			    xaxis=data.xaxis; 
                 datawz=data.shequ;
                 datawz1=data.pingjia;
                 datawz2=data.baoliao;
			     total=data.yijian;
...
<script type="text/javascript">
    $(function()
    {
        var url="ugc_data_statistics.jsp";
        $.ajax({
            type:"GET",
            url: url,
            dataType:"json",
