...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
       ...
       <a href="ugc_main.jsp" class="br-menu-link   menu-home">
        ...
        <a href="ugc_pingjia.jsp" class="br-menu-link active menu-channel">
            <div class="br-menu-item">
...
<div class="br-mainpanel with-first-nav">
     <iframe src="../content/content2018.jsp?id=14265" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
</div>
<!-- br-mainpanel -->
<!-- ########## END: MAIN PANEL ########## -->
