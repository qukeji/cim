...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        ...
        <!-- br-menu-link -->
         ...
         <a href="ugc_yijian.jsp" class="br-menu-link active menu-source">
            <div class="br-menu-item">
...
<div class="br-mainpanel with-first-nav">
     <iframe src="../content/content2018.jsp?id=14268" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
</div>
<!-- br-mainpanel -->
<!-- ########## END: MAIN PANEL ########## -->
