...
<body class="collapsed-menu email" id="withSecondNav">
	...
	<%@include file="../company/company_tree.jsp"%><!--静态包含-->

	<%@include file="../company/header.jsp"%><!--静态包含-->
    ...
    <div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
        <iframe src="company_user_list2018.jsp?GroupID=-1" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
...
//=============================================================================================================
		...
		function menu_init(type,obj){
			...
			$.ajax({
				type:"GET",
				dataType:"json",
				url:"/tcenter/tcenter/company/company_tree.jsp?type=3",
				success: function(json){
