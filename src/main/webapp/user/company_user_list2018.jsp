...
function gopage(currpage) {
	var url = "../user/company_user_list2018.jsp?GroupID=<%=GroupID%>&type=<%=type%>&company=<%=company%>&currPage=" + currpage + "&rowsPerPage=<%=rowsPerPage%>";
	this.location = url;
}
...
function change(obj)
{
	if(obj!=null)		this.location="../user/company_user_list2018.jsp?GroupID=<%=GroupID%>&type=<%=type%>&company=<%=company%>&rowsPerPage="+obj.value;
}
...
jQuery(document).ready(function(){
	...
	jQuery("#goToId").click(function(){
		...
		if(num<1)
			num=1;
		var href="../user/company_user_list2018.jsp?GroupID=<%=GroupID%>&type=<%=type%>&company=<%=company%>&currPage="+num+"&rowsPerPage=<%=rowsPerPage%>";
