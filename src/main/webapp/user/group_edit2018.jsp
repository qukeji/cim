...
if(!Name.equals(""))
{
	...
	UserGroup parentGroup = new UserGroup(GroupID);
	out.println("<script>top.TideDialogClose({refresh:'left',returnNavValue:{group:'"+GroupID+"',SuperGroup:"+parentGroup.getParent()+"}});</script>");return;
}
%>
<!DOCTYPE HTML>
<html>
