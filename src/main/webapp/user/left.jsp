  ...
  <tr> 
    <td height="36" align="center" class="font-14"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="left"><img id="icon" src="../images/icon_user_24.gif" border="0" align="absmiddle">用户管理</td>
          <td width="8"></td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td align="center" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="center" valign="top" class="box-white" id="leftFrm"><iframe frameborder=0 scrolling=no src="user_tree.jsp" style="height:100%;visibility:inherit;width:100%;"></iframe></td>
