...
<body class="collapsed-menu email" id="withSecondNav">
    ...
    <div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
        <iframe src="user_list2018.jsp?GroupID=-1" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
...
//=============================================================================================================
		...
		function menu_init(type,obj){
			...
			$.ajax({
				type:"GET",
				dataType:"json",
				url:"../tcenter/company/company_tree.jsp?type=3",
				success: function(json){
					var menu = $('.sidebar-menu');
					var html = '<li class="treeview">';
					html += '<a href="javascript:;" id="1" company="0" type="0" load="0"><i class="fa fisrtNav fa-home"></i><span>所有用户</span></a>';
					html += '<ul class="treeview-menu " style="display: block;">';

					for(var i=0;i<json.length;i++){

						html += '<li><a href="#" id="1" company="'+json[i].company+'" type="'+json[i].type+'" load="1" class="company_'+json[i].company+'">';

						html += '<i class="fa fisrtNav fa-home"></i>';
...
//===================================================================
	...
	//		}else{
				if(id==1){id=-1}
				changeFrameSrc( window.frames["content_frame"] , "../user/user_list2018.jsp?GroupID="+id+"&type="+type+"&company="+company );
	//		}
