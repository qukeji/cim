...
function Save()
{
	...
	$.ajax({
         type: "POST",
         url:"../util/document_sensitive_word_submit.jsp",
         data:$('#form').serialize(),
		 dataType:'json',
...
<form name="form" action="../util/document_sensitive_word_submit.jsp" method="post" id = "form">
<div class="header">
...
<%if(item!=null){item.setCurrentPage(1);%>currcontent = '<%=Util.JSQuote(item.getContent().replaceAll(outer_url,inner_url))%>';//Oracle not need JsQuote;
