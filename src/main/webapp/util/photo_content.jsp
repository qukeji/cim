...
<div class="viewpane_c1" id="SearchArea" style="display:<%=(S_OpenSearch==1?"":"none")%>">
  ...
  <tr>
    <td width="20">&nbsp;</td>
    <td><form name="search_form" action="photo_content.jsp?rowsPerPage=<%=rowsPerPage%>" method="post" onSubmit="document.search_form.OpenSearch.value='1';">检索：标题
...
String ListSql = "SELECT itemid,subject,uid,username,FROM_UNIXTIME(dateline) as dateline FROM supe_spaceitems WHERE type='image'";
String CountSql = "SELECT count(*) FROM supe_spaceitems WHERE type='image'";
