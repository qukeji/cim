...
String ListSql = "select type,platform,audience_type,id,Title,Photo,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews,state";
...
<thead>
		<tr id="oTable_th">
					...
					<%}%>
    				<th class="v1"	align="center" valign="middle">类型</th>
    				<th class="v8"  align="center" valign="middle">平台</th>
    				<th class="v4"  align="center" valign="middle">对象</th>
					<th class="v4"  align="center" valign="middle">推送结果</th>
					<th class="v4"  align="center" valign="middle">时间</th>
    				<%if(IsComment==1){%>
...
while(Rs.next())
{
	...
	String state = Rs.getInt("state")>0?"成功":"失败";

	String type_	="";
	int type_int= Rs.getInt("type");
	if(type_int==1){
		type_="通知";
	}
	else if(type_int==2){
	...
	String platform	= convertNull(Rs.getString("platform"));
	String audience_type = "";
	int audience_type_int= Rs.getInt("audience_type");
	switch(audience_type_int){
		case 1 : audience_type="所有人";break;
		case 2 : audience_type="标签";break;
		case 3 : audience_type="别名";break;
		case 4 : audience_type="序列号";break;
	}
...
%>
  <tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>"  status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item">
	...
	<td class="v1" align="center" valign="middle"><%=type_%></td>
    <td class="v8" align="center" valign="middle"> <%=platform%></td>
     <td class="v4" align="center" valign="middle"><%=audience_type%></td>
	<td class="v4" align="center" valign="middle"><%=state%></td>
	<td class="v4" align="center" valign="middle"><%=ModifiedDate%></td>
