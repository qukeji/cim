...
function uploadVideo()
{
	...
	dialog.setUrl("video/video_upload.jsp?FolderName=&SiteId=4&ChannelID="+ChannelID);
...
function chooseVideo()
{
	...
	dialog.setUrl("vms/file_list_choose.jsp?ChannelID="+ChannelID);
...
<div class="content_t1">
    ...
    <div class="content_new_post">
		...
		<div class="top_button button_inline_block" onClick="uploadVideo();">
				<div class="top_button_outer button_inline_block">
					<div class="top_button_inner button_inline_block">
		...
		<div class="top_button button_inline_block" onClick="chooseVideo();">
				<div class="top_button_outer button_inline_block">
					<div class="top_button_inner button_inline_block">
						<span class="img"><img src="../images/icon/add.png" /></span>
						<span class="txt">选择视频</span>
					</div>
				</div>	
		</div>
		<%if(canAdd){%>
