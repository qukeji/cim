...
String file_types = CmsCache.getParameterValue("local_video_type");
...
<script type="text/javascript" src="../swfupload/handlers.js"></script>
	...
	window.onload = function() {
			var settings = {
				...
				upload_url: "<%=request.getContextPath()%>/vms/video_upload_submit.jsp",	// Relative to the SWF file
				post_params: {},
				file_size_limit : "0",
...
<table  border="0">
   <tr>
    <td align="left" valign="middle"><span class="file_upload_dir">视频上传：</span>
