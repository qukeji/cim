...
<body class="collapsed-menu email" id="withSecondNav" onLoad="init();">
    ...
    <div class="br-mainpanel with-second-nav br-mainpanel-file " id="js-source">
        <iframe src="../channel/channel2018.jsp?ChannelID=15892" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
    </div><!-- br-mainpanel -->
