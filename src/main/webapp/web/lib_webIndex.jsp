<%@ page import="tidemedia.cms.system.*,java.util.Date,org.json.*,java.sql.*,tidemedia.cms.base.*,
				tidemedia.cms.user.*"%>
...
result = ChannelUtil.getApplicationChannel("",companyid,2,userinfo_session);
