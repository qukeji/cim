...
id = CmsCache.getParameter("sys_tidehome_config").getJson().getInt("baoliao");
if(currPage<1)
	currPage = 1;
...
<div class="content_t1">
	<div class="content_t1_nav">当前位置：爆料</div>
...
<thead>
		<tr id="oTable_th">
    				...
    				<th align="center" valign="middle">用户</th>
					<th align="center" valign="middle">评论内容</th>
...
String ListSql = "select id,Title,Content,userid,video,Photo,Active,FROM_UNIXTIME(CreateDate) as CreateDate,Status from "+Table+" where  Active= "+IsActive;
