...
id = CmsCache.getParameter("sys_tidehome_config").getJson().getInt("collect");
if(currPage<1)
	currPage = 1;
...
<div class="content_t1">
	<div class="content_t1_nav">当前位置：收藏</div>
...
String ListSql = "select id,Title,item_gid,userid,Status,Active,FROM_UNIXTIME(CreateDate) as CreateDate,url,type,author from "+Table+" where  Active= "+IsActive;
...
while(Rs.next())
{
	...
	String typeDesc="";
	switch(type){
		case 1:typeDesc="文章";break;
		case 2:typeDesc="图片";break;
		case 3:typeDesc="视频";break;
		default : typeDesc = "其他";
	}
...
%>
  <tr No="<%=j%>" ItemID="<%=id_%>"  id="item_<%=id_%>" id_="<%=id_%>" class="tide_item">
    ...
    <td align="center" valign="middle"><%=typeDesc%></td>
