...
<title>用户管理 <%=CmsCache.getCompany()%></title>
...
<div class="column_nav" id="leftTd"><iframe frameborder="0" src="left.jsp?menu=<%=menu%>" style="width:100%;height:100%;" name="ifm_left" id="ifm_left"></iframe></div>
...
<div class="column_viewer" id="rightTd"><iframe frameborder="0" src="" style="width:100%;height:100%;" name="ifm_right" id="ifm_right"></iframe></div>
