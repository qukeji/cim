...
<title>用户交互中心<%=CmsCache.getCompany()%></title>
...
<div class="frame">
	<div class="frame_tool">
    	<div class="frame_tool_l">
        	<div class="frame_logo"><a href="<%=base%>/tcenter/main.jsp">tidemedia center</a></div><span class="frame_tool_arr">></span><div class="frame_product_name">用户交互中心</div>
        </div>
...
<div class="header_menu" id="sns">
	<ul>
		...
		<li id="home_user" ><a href="javascript:menu('user');">注册用户管理</a></li>
		<li id="home_manage"><a href="javascript:menu('manage');">交互应用管理</a></li>
    </ul>
</div>
