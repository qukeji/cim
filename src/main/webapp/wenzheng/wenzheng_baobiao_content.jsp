...
<%
    ...
    String channel_SerialNo = "s66_h";//问政bao'biao信息频道标识
...
//			        System.out.println("======================================categoryWhere="+categoryWhere);
    ...
    int Status33			=	getIntParameter(request,"Status3");
...
function overDocument_confirm(id,length){
	...
	$.ajax({
        ...
        function exportExcel(){
    		...
    		var url= "../../tcenter/wenzheng/export_excel_wenzhengbaobiao.jsp?Status3="+<%=Status33%>+"&ChannelID="+<%=ChannelID%>;
    	    $.ajax({
    	 	type: "GET",
    	 	url: url,
         	dataType:"json",
...
//添加判断有内容类型的频道
        ...
        if(doc_type_channel== -1){
            ListSql = "select id,Title,Photo,Status2,Status3,Weight,GlobalID,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews,probstatus,CreateDate";
        }else{
            ListSql = "select id,Title,doc_type,Status2,Status3,Photo,Weight,GlobalID,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews,probstatus,CreateDate";
        }
...
if(S_IsIncludeSubChannel==1)
{
	WhereSql += " and ChannelCode like '"+channel.getChannelCode() + "%'";
        ...
        if(Status33==-1){
            WhereSql += " and Status3=0";
        }else if(Status33==1){
            WhereSql += " and Status3=1";
        }else if(Status33==2){
            WhereSql += " and Status3=2";
        }
...
//System.out.println("==========================================================="+ListSql);
    ...
    <div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
        ...
        <div class="btn-group mg-l-10 hidden-xs-down">
            ...
            <a href="javascript:list('Status3=-1');" class="btn btn-outline-info list_receive">接收</a>
            <a href="javascript:list('Status3=1');" class="btn btn-outline-info list_zhuanban">转办</a>
            <a href="javascript:list('Status3=2');" class="btn btn-outline-info list_finish">办结</a>
        ...
        <div class="btn-group mg-l-auto hidden-sm-down">
            ...
            <%}%>
            <a href="javascript:exportExcel();" class="btn btn-outline-info">下载</a>
        </div>
        <!-- START: 按钮过多时的部分功能下拉 -->
        <div class="dropdown hidden-md-1500-up hidden-sm-down mg-l-10">
            <!-- dropdown-menu --> <!-- <button class="btn btn-info btn-sm mg-r-8 tx-13 " onclick="exportExcel()">下载</button>-->
        </div>
        <!-- dropdown -->
        <!-- END: 按钮过多时的部分功能下拉 -->
        <!-- START: 只显示在移动端 -->
        ...
        <div class="card bd-0 shadow-base">
            <table class="table mg-b-0 <%=listType==2?"table-fixed":""%>" id="content-table">
                ...
                <tr>
                    ...
                    <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-180">接收日期</th>
                    <th class="tx-12-force tx-mont tx-medium hidden-xs-down wd-180">状态</th>
                    <%if(IsComment==1){%>
                ...
                <%
                    ...
                    while(Rs.next())
                    {
                        ...
                        String status3Desc = "";
                        if(Status3==0){
                            status3Desc="<span class='tx-green'>平台接收</span>";
                        }else if(Status3==1){
                            status3Desc="<span class='tx-orange'>转办</span>";
                        }else if(Status3==2){
                            status3Desc="<span class='tx-success'>办结</span>";
                        }
    ...
    <div class="d-flex align-items-center justify-content-start pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
        ...
        <div class="btn-group mg-l-10 hidden-xs-down">
            <a href="javascript:list();" class="btn btn-outline-info list_all">全部</a>
            <a href="javascript:list('Status3=-1');" class="btn btn-outline-info list_delete">接收</a>
            <a href="javascript:list('Status3=1');" class="btn btn-outline-info list_delete">转办</a>
            <a href="javascript:list('Status3=2');" class="btn btn-outline-info list_delete">办结</a>
            <a href="#" class="btn btn-outline-info btn-search">搜索</a>
        </div>
        <!-- btn-group -->
    ...
    <script>
        ...
        $(function() {
            ...
            if (Status1_ == -1) {
                ...
                $(".list_receive").addClass("active");

            }else if (Status3_ == 1) {

                $(".list_zhuanban").addClass("active");
