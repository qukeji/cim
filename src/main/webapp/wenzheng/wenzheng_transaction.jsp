...
int channelid = wenzheng.getInt("wenzheng_tongji");//问政统计编号
...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
            ...
            <a href="wenzheng_main.jsp" class="br-menu-link menu-home">
            ...
            <%if(id==1){%>
            <a href="wenzheng_transaction.jsp?id=1" class="br-menu-link active menu-source">
            <%}else{%>
            ...
            <%if(id==2){%>
            <a href="wenzheng_transaction.jsp?id=2" class="br-menu-link active menu-source">
            <%}else{%>
            ...
            <%if(id==3){%>
            <a href="wenzheng_transaction.jsp?id=3" class="br-menu-link active menu-source">
            <%}else{%>
...
<div class="br-mainpanel with-first-nav">
     <iframe src="content2018.jsp?id=<%=id%>" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
</div>
<!-- br-mainpanel -->
<!-- ########## END: MAIN PANEL ########## -->
