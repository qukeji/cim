...
<div class="br-logo">
    <a href="../../tcenter/main.jsp"><img src="../images/2018/system-logo.png"></a>
</div>
...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        ...
        <a href="wenzhengIndex2018.jsp" class="br-menu-link menu-explorer">
            <div class="br-menu-item">
        ...
        <!-- br-menu-link -->
        <a href="wezheng_channel_statistical.jsp" class="br-menu-link active menu-source">
            <div class="br-menu-item">
...
<div class="br-mainpanel with-first-nav">
     <iframe src="content2018.jsp?id=16211" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
</div>
<!-- br-mainpanel -->
<!-- ########## END: MAIN PANEL ########## -->
