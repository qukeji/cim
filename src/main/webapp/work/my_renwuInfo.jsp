...
<%
    ...
    if(userinfo_session.getCompany()!=0){
        childChannel = new Tree().getChannelID(childChannel,userinfo_session);
    }
    channel = CmsCache.getChannel(childChannel);
    ...
    if(userinfo_session.getCompany()!=0){
        whereSql += " and Category = "+childChannel;
    }

    whereSql+=" order by ModifiedDate desc limit 10";
    ListSql += whereSql;
    System.out.println("renwu listsql="+ListSql);
    ...
    json.put("name","我的任务");
    json.put("addJs","siderightNewContent2("+childChannel+")");
