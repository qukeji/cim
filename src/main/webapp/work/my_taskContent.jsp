...
//添加判断有内容类型的频道
        String ListSql = "select id,Title,Photo,Weight,task_status,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Active,Category,IsPhotoNews";
            ...
            <table class="table mg-b-0 <%=listType==2?"table-fixed":""%>" id="content-table">
                ...
                <%
                    ...
                    while(Rs.next())
                    {
                        ...
                        {
                %>
                <tr No="<%=j%>" ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>" status="<%=Status%>" GlobalID="<%=GlobalID%>" id="item_<%=id_%>" class="tide_item" end="<%=end%>" actionId="<%=id_aa%>" approve="1" ApproveAction="<%=action%>" Editables="<%=editables%>">
                    ...
                    <td class="dropdown hidden-xs-down">
                        ...
                        <%}%>
                        <a href="javascript:approve_preview(<%=id_%>,<%=id_aa%>);" class="btn pd-0 mg-r-5" title="审核预览"><i class="fa fa-eye tx-18 handle-icon" aria-hidden="true"></i></a>
                        <%}%>
                ...
                <%}
                    if(listType==2)
                    {
                        ...
                        m++;
                %>
                <td id="item_<%=id_%>" status="<%=Status%>" class="tide_item" class="c" end="<%=end%>" actionId="<%=id_aa%>" approve="1">
                    <div class="row">
                        <div class="col-md">
                            <div class="card bd-0">
