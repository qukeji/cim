...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" id="" scroll="no" class="">
    ...
    <div class="br-mainpanel with-first-nav">   
        <iframe src="../../vms/video/myshiping_content.jsp?id=8800&userId=<%=userId%>" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>
        <!--<iframe src="../../vms/video/index_tcenter.jsp?channelid=8800&userId=<%=userId%>" id="content_frame" style="width: 100%;height: 100%;"  frameborder="0" onload="changeFrameHeight(this)"></iframe>-->
    </div><!-- br-mainpanel -->
