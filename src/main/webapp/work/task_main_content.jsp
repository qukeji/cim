			...
			<div class="row row-sm mg-t-20">
				<div class="col-sm-12 col-xl-8">
					<div class="card pd-0 bd-0 shadow-base">
						...
						<div class="pd-x-30 pd-b-40 pd-l-20">
							<ul class="screen-case">
								<li>
									<div class="screen-tl"><i class="tx-grey-3 fa fa-arrows-alt"></i>富县融媒体指挥中心大屏幕展示</div>
									<div class="screen-num">屏幕数量：<span>8</span></div>
									<a href="#" class="screen-scan">预览</a>
								</li>
								<li>
									<div class="screen-tl"><i class="tx-grey-3 fa fa-arrows-alt"></i>富县融媒体指挥中心大屏幕展示</div>
									<div class="screen-num">屏幕数量：<span>8</span></div>
