	...
	<div class="br-sideleft overflow-y-auto">
        ...
        <a href="Index2018.jsp" class="br-menu-link menu-explorer">
            <div class="br-menu-item">
                ...
                <span class="menu-item-label">舆情方案</span>
            </div>
        </a>
		...
		<div class="br-mainpanel with-first-nav">
			...
			<div class="d-flex pd-30">
				<div class="td-logo theme-bg mg-r-10"><i class="tx-white fa fa-commenting  tx-36"></i></div>
				<div class="">
                    <h4 class="tx-gray-800 mg-b-5">舆情数据系统</h4>
					<p class="mg-b-0">本系统用于构建全局多租户用户管理，接入用户的管理及用户日志查看</p>	
					</div>
								...
								<div class="d-flex align-items-center justify-content-between">
									<div>
										<p class="tx-13 tx-uppercase tx-inverse tx-spacing-1 tx-18">
											<i class="fa fa-line-chart theme-tx-color mg-r-5"></i>数据管理
										</p>										
									</div>									
								</div>
							</div>
    ...
    var url="yuqing_main_chart.jsp";
	 $.ajax({
            ...
            success: function(data){
			    ...
			    xaxis=data.xaxis; 
			    task_status0=data.task_status0;
			    task_status1=data.task_status1;
			    task_status2=data.task_status2;
			    task_status3=data.task_status3;
			     
                 var dataArray = new Array();
                 for(var i=0; i<xaxis.length;i++){
                    
                    dataArray.push({y:xaxis[i], a: task_status0[i],b:task_status1[i],c:task_status2[i],d:task_status3[i]});
                     }
            	    ...
            	    xkey: 'y',
            	    ykeys: ['a','b','c','d'],
            	    labels: ['未审核','审核通过','毙搞','已完成'],
            	    lineColors: ['#f55d54', '#5058AB', '#00b297','#72DF00'],
            	    lineWidth: 1,
            	    ymax: 'auto 40',
            	    gridTextSize: 11,
            	    hideHover: 'auto',
...
<script type="text/javascript">
    $(function()
    {
        var url="yuqing_data_statistics.jsp";
        $.ajax({
            type:"GET",
            url: url,
            dataType:"json",
